...
<!-- أضيفي هذا الكود بعدو مباشرة -->
<li>
    <a href="{{ route('admin.link-projects') }}" class="dropdown-toggle no-arrow">
        <span class="micon bi bi-link-45deg"></span>
        <span class="mtext">🔗 ربط المشاريع مع منصة الفحص</span>
    </a>
</li>

<li>
    <a href="http://127.0.0.1:8001/dashboard" class="dropdown-toggle no-arrow" target="_blank">
        <span class="micon bi bi-file-code-fill"></span>
        <span class="mtext">Scanner*Dashboard*</span>
    </a>
</li>
<!-- كمان لو حابة تضيف صلاحية المشرفين -->
@if(auth()->user()->can_access_scanner ?? false)
<li>
    <a href="http://localhost/phpmyadmin/index.php?route=/database/structure&db=vertexgrad_scanner" 
       class="dropdown-toggle no-arrow" target="_blank">
        <span class="micon bi bi-shield-check"></span>
        <span class="mtext">📊 نتائج الفحص</span>
    </a>
</li>
@endif
