...
<div class="pd-ltr-20 xs-pd-20-10 report-history-page">
    ...
    <div class="hero-card">
        <div class="hero-content">
            ...
            <p class="hero-text">
                Review all generated report exports, track manual and scheduled execution, and download previous files from one elegant control center.
            </p>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="mini-stat">
                <div class="mini-stat-label">Total Exports</div>
    ...
    <div class="section-card">
        <div class="section-header">
            <h4>Generated Report Exports</h4>
            <p>Track scheduled and manual report generation history with direct file access.</p>
        </div>
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <div class="export-card">
                            <div class="d-flex justify-content-between align-items-start mb-3" style="gap: 10px;">
                                <div>
                                    <div class="export-title">
                                        {{ $export->template?->name ?? 'Report Export' }}
                                    </div>
                            ...
                            <div class="export-meta">
                                <div>
                                    ...
                                    @if($export->scheduled_report_id)
                                        <span class="badge-soft badge-source">Scheduled</span>
                                    @else
                                        <span class="badge-soft badge-source">Manual</span>
                                    @endif
                                </div>

                                <div><strong>Template:</strong> {{ $export->template?->name ?? '-' }}</div>
                                <div><strong>Generated By:</strong> {{ $export->user?->name ?? '-' }}</div>
                                <div>
                                    <strong>Generated At:</strong>
                                    {{ $export->generated_at ? $export->generated_at->timezone(config('app.timezone'))->format('Y-m-d h:i A') : '-' }}
                                </div>
                                <div><strong>File:</strong> {{ $export->file_path ? basename($export->file_path) : '-' }}</div>
                            </div>
                            ...
                            <div class="export-actions">
                                ...
                                <form action="{{ route('admin.reports.history.delete', $export->id) }}" method="POST" onsubmit="return confirm('Delete this export history item?')">
                                    @csrf
                                    @method('DELETE')
                ...
                @empty
                    <div class="col-12">
                        <div class="empty-state">
                            ...
                            <div class="empty-title">No Export History Yet</div>
                            <div class="empty-text">
                                Generated reports will appear here once you run or schedule exports.
                            </div>
