...
@section('title', 'Announcements History')
...
<div class="container-fluid py-4 px-lg-5">
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4 gap-3">
        <div>
            <h3 class="fw-bold mb-1 text-dark">Announcements History</h3>
            <p class="text-muted small mb-0">
                Browse, filter, and review all past and current announcements.
            </p>
        </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-6 col-xl">
            <div class="analytics-card">
                <span class="analytics-label">Active</span>
        ...
        <div class="col-md-6 col-xl">
            <div class="analytics-card">
                <span class="analytics-label">Expired</span>
        ...
        <div class="col-md-6 col-xl">
            <div class="analytics-card">
                <span class="analytics-label">Pinned</span>
    ...
    <div class="filter-card mb-4">
        <form method="GET" action="{{ route('admin.announcements.history') }}">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-4 col-lg-3">
                    <label class="form-label fw-semibold text-dark">Audience</label>
                    <select name="audience" class="form-select rounded-3">
                        ...
                        <option value="investors" {{ request('audience') === 'investors' ? 'selected' : '' }}>Investors</option>
                        <option value="supervisors" {{ request('audience') === 'supervisors' ? 'selected' : '' }}>Supervisors</option>
                    </select>
                </div>
