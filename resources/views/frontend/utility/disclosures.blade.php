...
@section('title', __('frontend.disclosures.title') . ' | ' . config('app.name'))
@section('meta_description', __('frontend.disclosures.subtitle'))
@section('canonical', route('utility.disclosures'))
@section('content')
