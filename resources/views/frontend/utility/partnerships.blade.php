...
@section('title', __('frontend.partnerships.title') . ' | ' . config('app.name'))
@section('meta_description', __('frontend.partnerships.subtitle'))
@section('canonical', route('utility.partnerships'))
@section('content')
