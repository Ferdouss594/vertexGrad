...
<div class="min-h-screen py-20" style="background-color: {{ $darkBg }};">
    <div class="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-cardLight/70 p-10 rounded-xl border border-light/20 shadow-xl space-y-8 text-light/80">
            ...
            <section>
                <h3 class="text-3xl font-semibold text-primary mb-4">1. Acceptance of Terms</h3>
                <p>
            ...
            <section>
                <h3 class="text-3xl font-semibold text-primary mb-4">2. User Responsibilities (Academics)</h3>
            ...
            <section>
                <h3 class="text-3xl font-semibold text-primary mb-4">3. Investor Obligations</h3>
                <ul class="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
                <h3 class="text-3xl font-semibold text-primary mb-4">4. Limitation of Liability</h3>
                <p>
