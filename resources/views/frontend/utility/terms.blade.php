...
@section('title', __('frontend.terms.title') . ' | ' . config('app.name'))
@section('meta_description', __('frontend.terms.subtitle'))
@section('canonical', route('utility.terms'))
@section('content')
<div class="min-h-screen py-12 sm:py-16 lg:py-20 bg-theme-bg transition-colors duration-300 overflow-x-hidden">
    <div class="w-full max-w-5xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div class="theme-panel p-4 sm:p-6 lg:p-10 rounded-xl space-y-6 sm:space-y-8 text-theme-muted">
            <section>
                <h3 class="text-2xl sm:text-3xl font-semibold text-brand-accent mb-3 sm:mb-4 break-words">{{ __('frontend.terms.section1_title') }}</h3>
                <p class="text-sm sm:text-base leading-7 sm:leading-8">{{ __('frontend.terms.section1_text') }}</p>
            </section>

            <section>
                <h3 class="text-2xl sm:text-3xl font-semibold text-brand-accent mb-3 sm:mb-4 break-words">{{ __('frontend.terms.section2_title') }}</h3>
            ...
            <section>
                <h3 class="text-2xl sm:text-3xl font-semibold text-brand-accent mb-3 sm:mb-4 break-words">{{ __('frontend.terms.section3_title') }}</h3>
                <ul class="list-disc list-outside space-y-2 ml-5 sm:ml-6 text-sm sm:text-base leading-7">
            ...
            <section>
                <h3 class="text-2xl sm:text-3xl font-semibold text-brand-accent mb-3 sm:mb-4 break-words">{{ __('frontend.terms.section4_title') }}</h3>
                <p class="text-sm sm:text-base leading-7 sm:leading-8">{{ __('frontend.terms.section4_text') }}</p>
            </section>
        </div>
