...
@section('title', __('frontend.process.title') . ' | ' . config('app.name'))
@section('meta_description', __('frontend.process.subtitle'))
@section('canonical', route('utility.how-it-works'))
@section('content')
