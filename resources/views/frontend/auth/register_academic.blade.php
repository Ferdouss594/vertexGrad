    ...
    <div class="relative min-h-screen flex items-center justify-center px-4 pt-32 pb-16">
        <div class="w-full max-w-lg">
            ...
            <div class="theme-panel register-panel rounded-3xl shadow-brand-soft border border-theme-border/60 p-6 sm:p-8 lg:p-10">
                ...
                {{-- FORM --}}
                <form method="POST" action="{{ route('register.student.post') }}" class="space-y-5 register-form" id="academicRegisterForm">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="password" name="password" required class="register-input w-full rounded-2xl border border-theme-border bg-theme-surface-2 py-3 px-4 text-theme-text">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" required class="register-input w-full rounded-2xl border border-theme-border bg-theme-surface-2 py-3 px-4 text-theme-text">
                    </div>
