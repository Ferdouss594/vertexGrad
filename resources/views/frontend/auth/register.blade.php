...
<div class="min-h-screen bg-theme-bg transition-colors duration-300 relative overflow-hidden">
    ...
    <div class="relative min-h-screen flex items-start justify-center px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-14">
        <div class="w-full max-w-5xl text-center">
            <div class="register-choice-heading">
                ...
                <p class="text-base sm:text-lg text-theme-muted mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed">
                    {{ __('frontend.auth.choose_registration_type') }}
                </p>
            </div>

            @if ($errors->any())
                <div class="register-choice-alert max-w-md mx-auto mb-6 p-4 rounded-2xl bg-red-500/10 border border-red-400/40 text-red-500 text-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6">
                <a href="{{ route('register.investor') }}"
                   class="register-choice-card min-h-[215px] p-6 sm:p-7 lg:p-8 rounded-3xl theme-panel border border-theme-border/60 hover:bg-theme-surface-2 transition duration-300 shadow-brand-soft block group text-center">
                    <div class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-3xl bg-brand-accent/10 border border-brand-accent/20 text-brand-accent shadow-brand-soft">
                    ...
                    <h3 class="text-2xl sm:text-[1.7rem] font-black text-theme-text mb-3 leading-tight">
                        {{ __('frontend.auth.investor_fund_manager') }}
                    </h3>

                    <p class="text-sm sm:text-base text-theme-muted mb-6 leading-relaxed">
            ...
            <p class="register-choice-login mt-8 sm:mt-10 text-center text-theme-muted text-sm">
