...
@section('title', __('frontend.submit_step1.page_title') . ' | ' . config('app.name'))
@section('meta_description', __('frontend.submit_step1.page_subtitle'))
@section('canonical', route('project.submit.step1'))
