    ...
    <div class="pre-loader">
        <div class="pre-loader-box">
            <div class="loader-logo">
                <img src="{{ asset('vendors/images/deskapp-logo.svg') }}" alt="DeskApp Logo" />
            </div>
...
<div class="user-info-dropdown">
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
            <a class="dropdown-item" href="{{ asset('profile.html') }}">
...
<div class="right-sidebar">
    ...
    <div class="right-sidebar-body customscroll">
        <div class="right-sidebar-body-content">
            <!-- باقي محتوى الإعدادات بدون تغيير -->
        </div>
    </div>
</div>
    ...
    <div class="sidebar-menu">
        <ul id="accordion-menu">
            <li class="dropdown">
                ...
                <ul class="submenu">
                    <li><a href="{{ asset('index.html') }}">Dashboard style 1</a></li>
                    <li><a href="{{ asset('index2.html') }}">Dashboard style 2</a></li>
                    <li><a href="{{ asset('index3.html') }}">Dashboard style 3</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="javascript:;" class="dropdown-toggle">
                ...
                <ul class="submenu">
                    <li><a href="{{ asset('form-basic.html') }}">Form Basic</a></li>
                    <li><a href="{{ asset('advanced-components.html') }}">Advanced Components</a></li>
                    <li><a href="{{ asset('form-wizard.html') }}">Form Wizard</a></li>
                    <li><a href="{{ asset('html5-editor.html') }}">HTML5 Editor</a></li>
                    <li><a href="{{ asset('form-pickers.html') }}">Form Pickers</a></li>
                    <li><a href="{{ asset('image-cropper.html') }}">Image Cropper</a></li>
                    <li><a href="{{ asset('image-dropzone.html') }}">Image Dropzone</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="javascript:;" class="dropdown-toggle">
                ...
                <ul class="submenu">
                    <li><a href="{{ asset('basic-table.html') }}">Basic Tables</a></li>
                    <li><a href="{{ asset('datatable.html') }}">DataTables</a></li>
                </ul>
            </li>
            <li>
                <a href="{{ asset('calendar.html') }}" class="dropdown-toggle no-arrow">
            ...
            <li class="dropdown">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="{{ asset('ui-cards-hover.html') }}">Cards Hover</a></li>
                    <li><a href="{{ asset('ui-modals.html') }}">Modals</a></li>
                    <li><a href="{{ asset('ui-tabs.html') }}">Tabs</a></li>
                    <li><a href="{{ asset('ui-tooltip-popover.html') }}">Tooltip & Popover</a></li>
                    <li><a href="{{ asset('ui-sweet-alert.html') }}">Sweet Alert</a></li>
                    <li><a href="{{ asset('ui-notification.html') }}">Notification</a></li>
                    <li><a href="{{ asset('ui-timeline.html') }}">Timeline</a></li>
                    ...
                    <li><a href="{{ asset('ui-range-slider.html') }}">Range slider</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="submenu">
                    <li><a href="{{ asset('bootstrap-icon.html') }}">Bootstrap Icons</a></li>
                    <li><a href="{{ asset('font-awesome.html') }}">FontAwesome Icons</a></li>
                    <li><a href="{{ asset('foundation.html') }}">Foundation Icons</a></li>
                    <li><a href="{{ asset('ionicons.html') }}">Ionicons Icons</a></li>
                    <li><a href="{{ asset('themify.html') }}">Themify Icons</a></li>
                    <li><a href="{{ asset('custom-icon.html') }}">Custom Icons</a></li>
                </ul>
            </li>
            <!-- باقي القوائم بنفس النمط -->
            <li>
...
<div class="welcome-modal">
    <button class="welcome-modal-close"><i class="bi bi-x-lg"></i></button>
    ...
    <p class="font-14 text-center mb-1 d-none d-md-block">Available in the following technologies:</p>
    <div class="d-none d-md-flex justify-content-center h1 mb-0 text-danger">
        <i class="fa fa-html5"></i>
    </div>
</div>
<button class="welcome-modal-btn"><i class="fa fa-download"></i> Download</button>
<!-- welcome modal end -->
