...
<div class="left-side-bar">
    ...
    8<div class="menu-block customscroll">
    <div class="sidebar-menu">
        <ul id="accordion-menu">
            <li class="menu-title">
                <span class="mtext text-uppercase small text-muted">Supervisor Panel</span>
            </li>

            <li>
                <a href="{{ route('supervisor.dashboard') }}" class="dropdown-toggle no-arrow" style="margin-top:10px;">
            ...
            <li>
                <a href="{{ route('supervisor.projects.index') }}" class="dropdown-toggle no-arrow">
                    <span class="micon bi bi-folder-fill"></span>
                    <span class="mtext">My Projects</span>
                </a>
            </li>

            <li>
                <a href="{{ route('supervisor.projects.pending') }}" class="dropdown-toggle no-arrow">
                    <span class="micon bi bi-hourglass-top"></span>
                    <span class="mtext">Pending Reviews</span>
                </a>
            </li>

            <li>
                <a href="{{ route('supervisor.projects.approved') }}" class="dropdown-toggle no-arrow">
                    <span class="micon bi bi-check2-circle"></span>
                    <span class="mtext">Approved Projects</span>
                </a>
            </li>

            <li>
                <a href="{{ route('supervisor.projects.revisions') }}" class="dropdown-toggle no-arrow">
                    <span class="micon bi bi-arrow-clockwise"></span>
                    <span class="mtext">Revision Requests</span>
                </a>
            </li>

            <li>
                <a href="{{ route('supervisor.profile.index') }}" class="dropdown-toggle no-arrow">
