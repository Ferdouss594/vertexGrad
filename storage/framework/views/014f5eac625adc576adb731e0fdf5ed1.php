...
<header class="w-full fixed top-0 left-0 z-50 border-b header-shell transition-colors duration-300">
    <div class="<?php echo e(config('design.classes.container')); ?> flex items-center justify-between h-20 gap-4">

        
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 shrink-0 min-w-0">
            <img
                src="<?php echo e(config('design.brand.logo') ? asset(config('design.brand.logo')) : asset('images/logo.png')); ?>"
                alt="<?php echo e(config('design.brand.name', 'VertexGrad')); ?>"
            ...
            <span class="font-extrabold text-2xl tracking-tight text-brand-accent whitespace-nowrap">
                <?php echo e(config('design.brand.name', 'VertexGrad')); ?>
        ...
        <nav class="hidden lg:flex items-center gap-8 min-w-0">
            <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($link['href']); ?>"
                   class="<?php echo e($transitionBase); ?> text-theme-text hover-text-brand-accent relative group uppercase text-[11px] tracking-[0.16em] font-bold whitespace-nowrap">
                    <?php echo e($link['label']); ?>

                    <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-brand-accent transform scale-x-0 group-hover:scale-x-100 <?php echo e($transitionBase); ?>"></span>
                </a>
        ...
        <div class="hidden md:flex items-center gap-3 shrink-0">
            ...
            <div
                ...
                x-data="{
                    open: false,
                    currentTheme: localStorage.getItem('vertexgrad_theme') || '<?php echo e(config('design.default_theme', 'brand')); ?>',
                    setTheme(theme) {
            ...
            >
                ...
                >
                    <?php echo e(__('frontend.header.theme')); ?>
                ...
                >
                    ...
                    >
                        <span class="text-sm font-semibold text-theme-text"><?php echo e(__('frontend.header.vertexgrad_theme')); ?></span>
                    ...
                    >
                        <span class="text-sm font-semibold text-theme-text"><?php echo e(__('frontend.header.dark_theme')); ?></span>
                    ...
                    <button
                        ...
                        class="w-full flex items-center justify-between px-4 py-3 text-left hover:bg-brand-accent-soft transition border-t border-theme-border"
                    >
                        <span class="text-sm font-semibold text-theme-text"><?php echo e(__('frontend.header.light_theme')); ?></span>
            ...
            <a
                href="<?php echo e(route('frontend.language.switch', $nextLocale)); ?>"
            ...
            <?php if(auth()->guard('web')->guest()): ?>
                <a href="<?php echo e(route('login.show')); ?>"
                   class="text-theme-muted hover-text-brand-accent text-xs font-bold uppercase tracking-widest <?php echo e($transitionBase); ?> whitespace-nowrap">
                    <?php echo e(__('frontend.header.sign_in')); ?>
                ...
                <a href="<?php echo e(route('frontend.projects.index')); ?>"
                   class="inline-flex items-center justify-center rounded-xl px-6 py-3 text-xs font-extrabold bg-brand-accent text-white hover-bg-brand-accent-strong transition-all shadow-brand-soft whitespace-nowrap">
                    <?php echo e(__('frontend.header.browse_opportunities')); ?>
            ...
            <?php if(auth()->guard('web')->check()): ?>
                ...
                <div
                    ...
                    x-data="{ open:false }"
                    data-latest-url="<?php echo e(route('frontend.notifications.latest')); ?>"
                >
                    <button type="button"
                            @click="open = !open"
                        ...
                        <span
                            ...
                            class="absolute -top-1 -right-1 <?php echo e($initialUnread > 0 ? 'flex' : 'hidden'); ?> h-4 min-w-[16px] px-1 items-center justify-center rounded-full bg-red-500 text-[10px] font-black text-white shadow"
                        >
                            <?php echo e($initialUnread > 9 ? '9+' : $initialUnread); ?>
                    ...
                    <div x-show="open"
                        ...
                        <div class="p-4 border-b border-theme-border bg-brand-accent-soft flex justify-between items-center">
                            <h3 class="text-xs font-black uppercase tracking-widest text-brand-accent">
                                <?php echo e(__('frontend.header.alerts')); ?>

                            </h3>
                            <span class="text-[10px] text-theme-muted">
                                <span id="frontendUnreadText"><?php echo e($initialUnread); ?></span> <?php echo e(__('frontend.header.unread')); ?>
                        ...
                        <div id="frontendNotificationList" class="max-h-80 overflow-y-auto">
                            <?php $__empty_1 = true; $__currentLoopData = $latestNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <form method="POST"
                                      action="<?php echo e(route('frontend.notifications.read', $n->id)); ?>"
                                      class="block">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="redirect" value="<?php echo e($url); ?>">

                                    <button type="submit"
                                            class="w-full text-left block p-4 border-b border-theme-border hover:bg-brand-accent-soft transition <?php echo e($n->read_at ? 'opacity-50' : ''); ?>">
                                        <div class="flex gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <p class="text-xs font-bold text-theme-text truncate"><?php echo e($title); ?></p>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="p-8 text-center text-theme-muted text-xs italic">
                                    <?php echo e(__('frontend.header.no_alerts')); ?>
                        ...
                        <div class="grid grid-cols-2 border-t border-theme-border bg-brand-accent-soft">
                            <a href="<?php echo e(route('frontend.notifications.index')); ?>"
                               class="p-3 text-center text-[10px] font-black text-theme-muted hover-text-brand-accent transition border-r border-theme-border">
                                <?php echo e(__('frontend.header.view_all')); ?>

                            </a>
                            <form method="POST" action="<?php echo e(route('frontend.notifications.markAllRead')); ?>">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="p-3 w-full text-center text-[10px] font-black text-brand-accent hover:text-theme-text transition">
                                    <?php echo e(__('frontend.header.mark_all_read')); ?>
                ...
                <div class="flex items-center gap-3 ml-3 pl-3 border-l border-theme-border">
                    <div title="<?php echo e($user->role); ?>" class="shrink-0">
                    ...
                    <form action="<?php echo e(route('frontend.logout')); ?>" method="POST" class="inline">
                        ...
                        <button type="submit"
                            ...
                            <?php echo e(__('frontend.header.logout')); ?>
            ...
            >
                ...
                >
                    <button type="button" @click="setTheme('brand')" class="w-full px-4 py-3 text-left text-sm font-semibold text-theme-text hover:bg-brand-accent-soft transition">
                        <?php echo e(__('frontend.header.vertexgrad_theme')); ?>
                    ...
                    <button type="button" @click="setTheme('dark')" class="w-full px-4 py-3 text-left text-sm font-semibold text-theme-text hover:bg-brand-accent-soft transition border-t border-theme-border">
                        <?php echo e(__('frontend.header.dark_theme')); ?>
                    ...
                    <button type="button" @click="setTheme('light')" class="w-full px-4 py-3 text-left text-sm font-semibold text-theme-text hover:bg-brand-accent-soft transition border-t border-theme-border">
                        <?php echo e(__('frontend.header.light_theme')); ?>
...
</script><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/components/header.blade.php ENDPATH**/ ?>