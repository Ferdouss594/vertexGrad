            ...
            <div class="theme-panel rounded-2xl shadow-brand-soft border border-theme-border/60 p-8 backdrop-blur-sm">
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-3xl font-bold text-theme-text mb-2">
                        <?php echo e(__('Verify Your Email')); ?>

                    </h2>

                    <p class="text-theme-muted leading-relaxed">
                        <?php echo e(__('We sent a verification link to your email address. Please verify your account before continuing.')); ?>
                ...
                <form method="POST" action="<?php echo e(route('verification.send')); ?>" id="verifyEmailForm" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <button
                        type="submit"
                ...
                <form method="POST" action="<?php echo e(route('frontend.logout')); ?>" id="verifyLogoutForm" class="mt-4">
                    <?php echo csrf_field(); ?>
                    <button
                        type="submit"
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/frontend/auth/verify-email.blade.php ENDPATH**/ ?>