...
<div class="min-h-screen flex items-center justify-center py-12 bg-theme-bg transition-colors duration-300">
    <div class="w-full max-w-lg p-10 rounded-2xl theme-panel shadow-brand-soft">
        ...
        <h2 class="text-4xl font-bold text-center text-theme-text mb-2">
            <?php echo e(__('frontend.auth.sign_in_to')); ?> <span class="text-brand-accent"><?php echo e(__('frontend.auth.vertexgrad')); ?></span>
        </h2>

        <p class="text-center text-theme-muted mb-10">
            <?php echo e(__('frontend.auth.login_subtitle')); ?>
        ...
        <form method="POST" action="<?php echo e(route('login.post')); ?>" class="space-y-6">
            ...
            <div>
                <label class="block text-sm font-medium text-theme-muted mb-2">
                    <?php echo e(__('frontend.auth.username_or_email')); ?>
            ...
            <div class="relative">
                <label class="block text-sm font-medium text-theme-muted mb-2">
                    <?php echo e(__('frontend.auth.password')); ?>
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center text-sm text-theme-muted cursor-pointer">
                    ...
                    >
                    <?php echo e(__('frontend.auth.remember_me')); ?>

                </label>

                <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-brand-accent hover:underline">
                    <?php echo e(__('frontend.auth.forgot_password_short')); ?>
            ...
            >
                <?php echo e(__('frontend.auth.log_in')); ?>

            </button>
        </form>

        <p class="mt-8 text-center text-theme-muted text-sm">
            <?php echo e(__('frontend.auth.no_account')); ?>

            <a href="<?php echo e(route('register.show')); ?>" class="text-brand-accent underline">
                <?php echo e(__('frontend.auth.register_here')); ?>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/frontend/auth/login.blade.php ENDPATH**/ ?>