    ...
    <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header class="text-center mb-16">
            <h1 class="text-5xl font-extrabold text-theme-text mb-4">
                <?php echo e(__('frontend.careers.title_before')); ?>

                <span class="text-brand-accent"><?php echo e(__('frontend.careers.title_highlight')); ?></span>
            </h1>
            <p class="text-xl text-theme-muted max-w-3xl mx-auto">
                <?php echo e(__('frontend.careers.subtitle')); ?>

            </p>
        </header>

        <h2 class="text-3xl font-bold text-theme-text mb-8 border-b border-theme-border pb-3">
            <?php echo e(__('frontend.careers.open_positions')); ?> (<?php echo e(count($openRoles)); ?>)
        </h2>

        <div class="space-y-4">
            <?php $__currentLoopData = $openRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="theme-panel p-6 rounded-xl flex justify-between items-center hover:shadow-brand-soft transition duration-300">
                    <div>
                        <h3 class="text-2xl font-semibold text-theme-text"><?php echo e($role['title']); ?></h3>
                        <p class="text-theme-muted mt-1">
                            <?php echo e($role['location']); ?> &middot; <span class="text-brand-accent"><?php echo e($role['type']); ?></span>
                        </p>
                    </div>

                    <a href="/careers/apply/<?php echo e(strtolower(str_replace([' ', '(', ')'], '-', $role['title']))); ?>"
                       class="text-brand-accent hover:text-theme-text transition-colors duration-300 font-medium">
                        <?php echo e(__('frontend.careers.view_apply')); ?> <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                </div>
        ...
        <div class="mt-16 p-8 bg-brand-accent-soft border border-brand-accent/30 rounded-xl text-center">
            <h3 class="text-2xl font-bold text-theme-text"><?php echo e(__('frontend.careers.no_match_title')); ?></h3>
            <p class="text-lg text-brand-accent mt-2">
                <?php echo e(__('frontend.careers.no_match_text')); ?>

                <a href="/contact" class="hover:underline"><?php echo e(__('frontend.careers.contact_hr')); ?></a>
            </p>
        </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/frontend/utility/careers.blade.php ENDPATH**/ ?>