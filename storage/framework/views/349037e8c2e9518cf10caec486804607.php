        ...
        <header class="mb-12 flex flex-col md:flex-row md:justify-between md:items-end gap-6">
            <div>
                <h1 class="text-5xl font-black text-theme-text tracking-tighter uppercase">
                    <?php echo e(__('frontend.investor_dashboard.investor')); ?>

                    <span class="text-brand-accent"><?php echo e(__('frontend.investor_dashboard.dashboard')); ?></span>
                </h1>

                <p class="text-theme-muted text-xs font-bold tracking-[0.3em] mt-2 uppercase">
                    <?php echo e(__('frontend.investor_dashboard.subtitle')); ?>

                </p>
            </div>

            <div class="flex flex-wrap items-center gap-3">
                <a href="<?php echo e(route('settings.investor')); ?>" class="<?php echo e($btnSecondaryClass); ?>">
                    <i class="fas fa-cog mr-2"></i>
                    <?php echo e(__('frontend.investor_dashboard.settings', [], app()->getLocale())); ?>

                </a>

                <a href="<?php echo e(route('investor.investments')); ?>" class="<?php echo e($btnSecondaryClass); ?>">
                    <i class="fas fa-briefcase mr-2"></i>
                    <?php echo e(__('frontend.investments.my_investments', [], app()->getLocale())); ?>
        ...
        <div class="mb-8 md:hidden">
            <div class="theme-panel rounded-[2rem] p-5">
                <p class="text-theme-muted text-[10px] font-black uppercase tracking-widest">
                    <?php echo e(__('frontend.investor_dashboard.total_approved_funding')); ?>

                </p>
                <p class="text-3xl font-black text-green-600 mt-2">
                    $<?php echo e(number_format($totalDeployed)); ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex flex-wrap items-center gap-2 mb-3">
                                    <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-theme-surface-2 text-theme-muted border border-theme-border text-[11px] font-black uppercase tracking-[0.16em]">
                                        <?php echo e(__('frontend.investor_dashboard.announcement')); ?>
                                    ...
                                    <?php if($featuredAnnouncement->is_pinned): ?>
                                        <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-amber-400/10 text-amber-500 border border-amber-400/20 text-[11px] font-black uppercase tracking-[0.16em]">
                                            ...
                                            <?php echo e(__('frontend.investor_dashboard.pinned')); ?>
                                    ...
                                    <?php if($featuredAnnouncement->expires_at): ?>
                                        <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-red-500/10 text-red-500 border border-red-500/20 text-[11px] font-black uppercase tracking-[0.16em]">
                                            ...
                                            <?php echo e(__('frontend.investor_dashboard.until')); ?> <?php echo e($featuredAnnouncement->expires_at->format('M d, Y • h:i A')); ?>
                                        ...
                                        <div class="rounded-[1.5rem] border border-theme-border bg-theme-surface-2 transition p-4">
                                            ...
                                            <?php if($announcement->expires_at): ?>
                                                <div class="mt-3 text-[11px] text-red-500 font-semibold">
                                                    <?php echo e(__('frontend.investor_dashboard.visible_until')); ?> <?php echo e($announcement->expires_at->format('M d, Y • h:i A')); ?>
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <section class="theme-panel p-10 rounded-[3rem]">
                    <h3 class="text-xl font-black text-theme-text mb-8 flex items-center uppercase tracking-widest">
                        ...
                        <?php echo e(__('frontend.investor_dashboard.my_investment_activity')); ?>

                    </h3>

                    <div class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $myInvestments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $investment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <a href="<?php echo e(route('frontend.projects.show', $investment)); ?>"
                               class="p-6 bg-theme-surface-2 rounded-2xl border border-theme-border flex items-center justify-between hover:border-brand-accent/40 transition-all">
                                <div class="flex items-center gap-4 min-w-0">
                                    <div class="w-16 h-16 rounded-xl overflow-hidden bg-theme-surface flex items-center justify-center shrink-0">
                                        <?php if($image): ?>
                                            <img src="<?php echo e($image); ?>" alt="<?php echo e($investment->name); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-xs text-theme-muted mt-1 truncate">
                                            <?php echo e(__('frontend.investor_dashboard.lead')); ?>:
                                            <?php echo e($investment->student?->name ?? __('frontend.investor_dashboard.not_available')); ?>
                                        ...
                                        <div class="flex items-center gap-3 mt-2 flex-wrap">
                                            <?php if($video): ?>
                                                <span class="text-xs text-brand-accent flex items-center gap-1">
                                                    ...
                                                    <?php echo e(__('frontend.investor_dashboard.video_available')); ?>

                                                </span>
                                            <?php endif; ?>

                                            <?php if($investment->getMedia('images')->count() > 1): ?>
                                                <span class="text-xs text-theme-muted">
                                                    <?php echo e($investment->getMedia('images')->count()); ?> <?php echo e(__('frontend.investor_dashboard.images')); ?>
                                ...
                                <div class="text-right shrink-0 ml-4">
                                    <span class="text-brand-accent font-bold text-sm">
                                        <?php echo e(strtoupper($pivotStatus)); ?>

                                    </span>

                                    <p class="text-[10px] text-theme-muted uppercase mt-1">
                                        <?php echo e(__('frontend.investor_dashboard.budget')); ?>:
                                        $<?php echo e(number_format($investment->budget ?? 0)); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="text-center py-10 text-theme-muted italic text-sm">
                                <?php echo e(__('frontend.investor_dashboard.no_interest_yet')); ?>
                ...
                <section class="theme-panel p-10 rounded-[3rem]">
                    <div class="mb-8">
                        <h3 class="text-xl font-black text-theme-text uppercase tracking-widest">
                            <?php echo e(__('frontend.investor_dashboard.suggested_for_you')); ?>
                    ...
                    <div class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $suggestedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <a href="<?php echo e(route('frontend.projects.show', $deal)); ?>"
                               class="flex items-center justify-between p-6 bg-theme-surface-2 rounded-2xl border border-theme-border hover:border-brand-accent/40 transition-all group">
                                ...
                                <div class="flex items-center gap-4 min-w-0">
                                    <div class="w-16 h-16 rounded-xl overflow-hidden bg-theme-surface flex items-center justify-center shrink-0">
                                        <?php if($image): ?>
                                            <img src="<?php echo e($image); ?>" alt="<?php echo e($deal->name); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                                            <i class="fas fa-image text-theme-muted text-lg"></i>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <div class="flex items-center gap-3 mt-2 flex-wrap">
                                            <span class="text-xs text-theme-muted truncate">
                                                <?php echo e($deal->student?->name ?? __('frontend.investor_dashboard.researcher')); ?>
                                            ...
                                            <?php if($video): ?>
                                                <span class="text-xs text-brand-accent flex items-center gap-1">
                                                    <i class="fas fa-video"></i>
                                                    <?php echo e(__('frontend.investor_dashboard.video')); ?>
                                        ...
                                        <?php if($interestedCount > 0): ?>
                                            <div class="flex items-center gap-2 mt-3">
                                                ...
                                                <span class="text-xs text-theme-muted">
                                                    ...
                                                    <?php echo e(__('frontend.investor_dashboard.interested_investor_label', ['count' => $interestedCount])); ?>
                                ...
                                <div class="text-right shrink-0 ml-4">
                                    <span class="text-green-600 font-mono text-sm font-bold block">
                                        $<?php echo e(number_format($deal->budget ?? 0)); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="text-center py-10 text-theme-muted italic text-sm">
                                <?php echo e(__('frontend.investor_dashboard.no_open_opportunities')); ?>
                    ...
                    <div class="mt-6 pt-6 border-t border-theme-border">
                        <a href="<?php echo e(route('frontend.projects.index')); ?>"
                           class="inline-flex items-center justify-center rounded-2xl px-6 py-3 font-bold border border-brand-accent text-theme-text hover:bg-brand-accent hover:text-white transition duration-300">
                            ...
                            <?php echo e(__('frontend.investor_dashboard.explore_all')); ?>
            ...
            <div class="space-y-8">
                <div class="theme-panel p-10 rounded-[3rem]">
                    <h3 class="text-theme-text font-black uppercase tracking-widest text-sm mb-6">
                        <?php echo e(__('frontend.investor_dashboard.marketplace_overview')); ?>

                    </h3>

                    <div class="space-y-5 text-sm">
                        <div class="flex justify-between items-center">
                            <span class="text-theme-muted"><?php echo e(__('frontend.investor_dashboard.active_projects')); ?></span>
                            <span class="text-brand-accent font-bold"><?php echo e($marketplaceStats['active_projects']); ?></span>
                        </div>

                        <div class="flex justify-between items-center">
                            <span class="text-theme-muted"><?php echo e(__('frontend.investor_dashboard.interested')); ?></span>
                            <span class="text-theme-text font-bold"><?php echo e($marketplaceStats['interested_count']); ?></span>
                        </div>

                        <div class="flex justify-between items-center">
                            <span class="text-theme-muted"><?php echo e(__('frontend.investor_dashboard.funding_requested')); ?></span>
                            <span class="text-theme-text font-bold"><?php echo e($marketplaceStats['requested_count']); ?></span>
                        </div>

                        <div class="flex justify-between items-center">
                            <span class="text-theme-muted"><?php echo e(__('frontend.investor_dashboard.approved_investments')); ?></span>
                            <span class="text-green-600 font-bold"><?php echo e($marketplaceStats['approved_count']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="theme-panel p-10 rounded-[3rem]">
                    <h3 class="text-theme-text font-black uppercase tracking-widest text-sm mb-6">
                        <?php echo e(__('frontend.investor_dashboard.investor_summary')); ?>

                    </h3>

                    <div class="space-y-4 text-xs text-theme-muted leading-relaxed">
                        <p>
                            <span class="text-brand-accent"><?php echo e(__('frontend.investor_dashboard.focus')); ?>:</span>
                            <?php echo e(__('frontend.investor_dashboard.focus_text')); ?>

                        </p>

                        <p>
                            <span class="text-brand-accent"><?php echo e(__('frontend.investor_dashboard.status')); ?>:</span>
                            <?php echo e(__('frontend.investor_dashboard.status_text')); ?>

                        </p>

                        <p>
                            <span class="text-brand-accent"><?php echo e(__('frontend.investor_dashboard.action')); ?>:</span>
                            <?php echo e(__('frontend.investor_dashboard.action_text')); ?>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/frontend/dashboard/investor.blade.php ENDPATH**/ ?>