<?php $__env->startSection('title', __('backend.supervisor_dashboard.page_title')); ?>
...
<div class="pd-ltr-20 xs-pd-20-10 supervisor-dashboard-page">
    <div class="min-height-200px">
            ...
            <div class="row align-items-center">
                <div class="col-xl-8 col-lg-7">
                    <div class="hero-content">
                        <div class="hero-eyebrow"><?php echo e(__('backend.supervisor_dashboard.hero_badge')); ?></div>
                        <h2 class="hero-title"><?php echo e(__('backend.supervisor_dashboard.hero_title', ['name' => $user->name])); ?></h2>
                        <p class="hero-text">
                            <?php echo e(__('backend.supervisor_dashboard.hero_subtitle')); ?>

                        </p>

                        <div class="hero-actions">
                            <a href="<?php echo e(route('supervisor.projects.index')); ?>" class="hero-btn hero-btn-primary">
                                <i class="fa fa-folder-open mr-2"></i> <?php echo e(__('backend.supervisor_dashboard.my_projects')); ?>

                            </a>
                            <a href="<?php echo e(route('supervisor.projects.pending')); ?>" class="hero-btn hero-btn-outline">
                                <i class="fa fa-clock-o mr-2"></i> <?php echo e(__('backend.supervisor_dashboard.pending_reviews')); ?>
                ...
                <div class="col-xl-4 col-lg-5 mt-4 mt-lg-0">
                    <div class="hero-summary-card">
                        <div class="hero-summary-head">
                            <span><?php echo e(__('backend.supervisor_dashboard.review_performance')); ?></span>
                            <span class="hero-summary-badge">
                                <?php echo e($totalProjects); ?> <?php echo e(__('backend.supervisor_dashboard.projects')); ?>

                            </span>
                        </div>

                        <div class="hero-summary-score">
                            <div class="score-number"><?php echo e($avgScanScore); ?></div>
                            <div class="score-label"><?php echo e(__('backend.supervisor_dashboard.avg_scan_score')); ?></div>
                        </div>

                        <div class="hero-summary-metrics">
                            <div class="metric-item">
                                <span><?php echo e(__('backend.supervisor_dashboard.pending')); ?></span>
                                <strong><?php echo e($pendingReviews); ?></strong>
                            </div>
                            <div class="metric-item">
                                <span><?php echo e(__('backend.supervisor_dashboard.approved')); ?></span>
                                <strong><?php echo e($approvedProjects); ?></strong>
                            </div>
                            <div class="metric-item">
                                <span><?php echo e(__('backend.supervisor_dashboard.revisions')); ?></span>
                                <strong><?php echo e($revisionRequests); ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="announcement-main-content">
                    <div class="announcement-badges">
                        <span class="announcement-badge">
                            ...
                            <?php echo e(__('backend.supervisor_dashboard.announcement')); ?>
                        ...
                        <?php if($featuredAnnouncement->is_pinned): ?>
                            <span class="announcement-badge pinned">
                                ...
                                <?php echo e(__('backend.supervisor_dashboard.pinned')); ?>
                        ...
                        <?php if($featuredAnnouncement->expires_at): ?>
                            <span class="announcement-badge expire">
                                ...
                                <?php echo e(__('backend.supervisor_dashboard.until', ['date' => $featuredAnnouncement->expires_at->format('M d, Y • h:i A')])); ?>
                        ...
                        <div class="col-xl-4 col-md-6 mb-3">
                            <div class="announcement-mini-card">
                                ...
                                <div class="announcement-mini-text">
                                    <?php echo e(\Illuminate\Support\Str::limit($announcement->body, 170)); ?>

                                </div>

                                <?php if($announcement->expires_at): ?>
                                    <div class="announcement-mini-meta">
                                        <?php echo e(__('backend.supervisor_dashboard.visible_until', ['date' => $announcement->expires_at->format('M d, Y • h:i A')])); ?>
        ...
        <div class="row mb-4">
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="kpi-card kpi-primary">
                    ...
                    <div class="kpi-info">
                        <div class="kpi-label"><?php echo e(__('backend.supervisor_dashboard.total_projects')); ?></div>
                        <div class="kpi-value"><?php echo e($totalProjects); ?></div>
                        <div class="kpi-sub"><?php echo e(__('backend.supervisor_dashboard.total_projects_note')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="kpi-card kpi-warning">
                    ...
                    <div class="kpi-info">
                        <div class="kpi-label"><?php echo e(__('backend.supervisor_dashboard.pending_reviews')); ?></div>
                        <div class="kpi-value"><?php echo e($pendingReviews); ?></div>
                        <div class="kpi-sub"><?php echo e($pendingPercent); ?>%</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="kpi-card kpi-success">
                    ...
                    <div class="kpi-info">
                        <div class="kpi-label"><?php echo e(__('backend.supervisor_dashboard.approved_projects')); ?></div>
                        <div class="kpi-value"><?php echo e($approvedProjects); ?></div>
                        <div class="kpi-sub"><?php echo e($approvedPercent); ?>%</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-3">
                <div class="kpi-card kpi-danger">
                    ...
                    <div class="kpi-info">
                        <div class="kpi-label"><?php echo e(__('backend.supervisor_dashboard.revision_requests')); ?></div>
                        <div class="kpi-value"><?php echo e($revisionRequests); ?></div>
                        <div class="kpi-sub"><?php echo e($revisionPercent); ?>%</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-xl-5 mb-3">
                <div class="dashboard-panel h-100">
                    <div class="panel-header">
                        <div>
                            <h5><?php echo e(__('backend.supervisor_dashboard.review_distribution')); ?></h5>
                            <p class="mb-0"><?php echo e(__('backend.supervisor_dashboard.review_distribution_subtitle')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="donut-wrap">
                        <div class="donut-chart"
                             style="background:
                                conic-gradient(
                                    #f59e0b 0% <?php echo e($pendingPercent); ?>%,
                                    #22c55e <?php echo e($pendingPercent); ?>% <?php echo e($pendingPercent + $approvedPercent); ?>%,
                                    #ef4444 <?php echo e($pendingPercent + $approvedPercent); ?>% 100%
                                );">
                            <div class="donut-inner">
                                <div class="donut-total"><?php echo e($totalProjects); ?></div>
                                <div class="donut-label"><?php echo e(__('backend.supervisor_dashboard.projects')); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="legend-grid">
                        <div class="legend-item">
                            ...
                            <div>
                                <strong><?php echo e($pendingReviews); ?></strong>
                                <small><?php echo e(__('backend.supervisor_dashboard.pending')); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="legend-item">
                            ...
                            <div>
                                <strong><?php echo e($approvedProjects); ?></strong>
                                <small><?php echo e(__('backend.supervisor_dashboard.approved')); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="legend-item">
                            ...
                            <div>
                                <strong><?php echo e($revisionRequests); ?></strong>
                                <small><?php echo e(__('backend.supervisor_dashboard.revisions')); ?></small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-7 mb-3">
                <div class="dashboard-panel h-100">
                    <div class="panel-header">
                        <div>
                            <h5><?php echo e(__('backend.supervisor_dashboard.review_status_analytics')); ?></h5>
                            <p class="mb-0"><?php echo e(__('backend.supervisor_dashboard.review_status_analytics_subtitle')); ?></p>
                        </div>
                    </div>

                    <div class="bar-chart-wrap">
                        <div class="bar-group">
                            <div class="bar-value"><?php echo e($chartPending); ?></div>
                            <div class="bar-track">
                                <div class="bar-fill bar-fill-warning" style="height: <?php echo e(($chartPending / $barMax) * 100); ?>%;"></div>
                            </div>
                            <div class="bar-label"><?php echo e(__('backend.supervisor_dashboard.pending')); ?></div>
                        </div>

                        <div class="bar-group">
                            <div class="bar-value"><?php echo e($chartApproved); ?></div>
                            <div class="bar-track">
                                <div class="bar-fill bar-fill-success" style="height: <?php echo e(($chartApproved / $barMax) * 100); ?>%;"></div>
                            </div>
                            <div class="bar-label"><?php echo e(__('backend.supervisor_dashboard.approved')); ?></div>
                        </div>

                        <div class="bar-group">
                            <div class="bar-value"><?php echo e($chartRevision); ?></div>
                            <div class="bar-track">
                                <div class="bar-fill bar-fill-danger" style="height: <?php echo e(($chartRevision / $barMax) * 100); ?>%;"></div>
                            </div>
                            <div class="bar-label"><?php echo e(__('backend.supervisor_dashboard.revisions')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-4">
            <div class="col-xl-6 mb-3">
                <div class="dashboard-panel h-100">
                    <div class="panel-header">
                        <div>
                            <h5><?php echo e(__('backend.supervisor_dashboard.review_progress_breakdown')); ?></h5>
                            <p class="mb-0"><?php echo e(__('backend.supervisor_dashboard.review_progress_breakdown_subtitle')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="progress-block">
                        <div class="progress-row">
                            <div class="progress-meta">
                                <span><?php echo e(__('backend.supervisor_dashboard.pending_reviews_label')); ?></span>
                                <strong><?php echo e($pendingPercent); ?>%</strong>
                            </div>
                            <div class="custom-progress">
                                <div class="custom-progress-bar warning" style="width: <?php echo e($pendingPercent); ?>%;"></div>
                            </div>
                        </div>

                        <div class="progress-row">
                            <div class="progress-meta">
                                <span><?php echo e(__('backend.supervisor_dashboard.approved_projects_label')); ?></span>
                                <strong><?php echo e($approvedPercent); ?>%</strong>
                            </div>
                            <div class="custom-progress">
                                <div class="custom-progress-bar success" style="width: <?php echo e($approvedPercent); ?>%;"></div>
                            </div>
                        </div>

                        <div class="progress-row">
                            <div class="progress-meta">
                                <span><?php echo e(__('backend.supervisor_dashboard.revision_requests_label')); ?></span>
                                <strong><?php echo e($revisionPercent); ?>%</strong>
                            </div>
                            <div class="custom-progress">
                                <div class="custom-progress-bar danger" style="width: <?php echo e($revisionPercent); ?>%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6 mb-3">
                <div class="dashboard-panel h-100">
                    <div class="panel-header">
                        <div>
                            <h5><?php echo e(__('backend.supervisor_dashboard.scan_pipeline_snapshot')); ?></h5>
                            <p class="mb-0"><?php echo e(__('backend.supervisor_dashboard.scan_pipeline_snapshot_subtitle')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="scan-metric-grid">
                        <div class="scan-metric-card">
                            ...
                            <div class="scan-metric-text">
                                <span><?php echo e(__('backend.supervisor_dashboard.average_score')); ?></span>
                                <strong><?php echo e($avgScanScore); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="scan-metric-card">
                            ...
                            <div class="scan-metric-text">
                                <span><?php echo e(__('backend.supervisor_dashboard.completed_scans')); ?></span>
                                <strong><?php echo e($completedScan); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="scan-metric-card">
                            ...
                            <div class="scan-metric-text">
                                <span><?php echo e(__('backend.supervisor_dashboard.pending_scans')); ?></span>
                                <strong><?php echo e($pendingScan); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="scan-metric-card">
                            ...
                            <div class="scan-metric-text">
                                <span><?php echo e(__('backend.supervisor_dashboard.failed_scans')); ?></span>
                                <strong><?php echo e($failedScan); ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="dashboard-panel">
            <div class="panel-header">
                <div>
                    <h5><?php echo e(__('backend.supervisor_dashboard.recent_projects')); ?></h5>
                    <p class="mb-0"><?php echo e(__('backend.supervisor_dashboard.recent_projects_subtitle')); ?></p>
                </div>
                <a href="<?php echo e(route('supervisor.projects.index')); ?>" class="panel-action-btn">
                    <?php echo e(__('backend.supervisor_dashboard.view_all')); ?>

                </a>
            </div>

            <div class="panel-body p-0">
                <?php if($latestProjects->count()): ?>
                    <div class="table-responsive" style="overflow-x: hidden;">
                        <table class="table dashboard-table mb-0">
                            <thead>
                                <tr>
                                    <th style="width: 60px;"><?php echo e(__('backend.supervisor_dashboard.table_number')); ?></th>
                                    <th style="width: 220px;"><?php echo e(__('backend.supervisor_dashboard.project')); ?></th>
                                    <th style="width: 180px;"><?php echo e(__('backend.supervisor_dashboard.student')); ?></th>
                                    <th style="width: 140px;"><?php echo e(__('backend.supervisor_dashboard.status')); ?></th>
                                    <th style="width: 130px;"><?php echo e(__('backend.supervisor_dashboard.scanner')); ?></th>
                                    <th style="width: 100px;"><?php echo e(__('backend.supervisor_dashboard.score')); ?></th>
                                    <th style="width: 130px;"><?php echo e(__('backend.supervisor_dashboard.updated')); ?></th>
                                    <th class="text-end" style="width: 110px;"><?php echo e(__('backend.supervisor_dashboard.action')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="project-cell-title">
                                                <?php echo e($project->name ?? __('backend.supervisor_dashboard.untitled_project')); ?>

                                            </div>
                                            <div class="project-cell-sub">
                                                <?php echo e($project->category ?? __('backend.supervisor_dashboard.no_category')); ?>

                                            </div>
                                        </td>
                                        <td>
                                            <div class="project-cell-title">
                                                <?php echo e($project->student->name ?? __('backend.supervisor_dashboard.not_available')); ?>

                                            </div>
                                            <div class="project-cell-sub">
                                                <?php echo e($project->student->email ?? __('backend.supervisor_dashboard.no_email')); ?>

                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge-soft <?php echo e($statusClass); ?>">
                                                <?php echo e(ucfirst(str_replace('_', ' ', $project->status ?? __('backend.supervisor_dashboard.not_available')))); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge-soft <?php echo e($scanClass); ?>">
                                                <?php echo e(ucfirst(str_replace('_', ' ', $project->scanner_status ?? __('backend.supervisor_dashboard.not_available')))); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <div class="score-pill"><?php echo e($project->scan_score ?? __('backend.supervisor_dashboard.empty_score')); ?></div>
                                        </td>
                                        <td>
                                            <div class="project-cell-title">
                                                <?php echo e(optional($project->updated_at)->format('Y-m-d') ?? __('backend.supervisor_dashboard.empty_date')); ?>

                                            </div>
                                            <div class="project-cell-sub">
                                                <?php echo e(optional($project->updated_at)->format('h:i A') ?? ''); ?>

                                            </div>
                                        </td>
                                        <td class="text-end">
                                            <a href="<?php echo e(route('supervisor.projects.show', $project->project_id)); ?>" class="table-action-btn">
                                                <?php echo e(__('backend.supervisor_dashboard.open')); ?>
                    ...
                    <?php if($latestProjects instanceof \Illuminate\Pagination\LengthAwarePaginator && $latestProjects->lastPage() > 1): ?>
                        <div class="custom-pagination-wrap">
                            <div class="custom-pagination">
                                <?php for($i = 1; $i <= $latestProjects->lastPage(); $i++): ?>
                                    <a href="<?php echo e($latestProjects->url($i)); ?>"
                                       class="custom-page-item <?php echo e($latestProjects->currentPage() == $i ? 'active' : ''); ?>">
                                        <?php echo e($i); ?>
                ...
                <?php else: ?>
                    <div class="empty-dashboard-state">
                        ...
                        <h6><?php echo e(__('backend.supervisor_dashboard.no_projects_available')); ?></h6>
                        <p class="mb-0"><?php echo e(__('backend.supervisor_dashboard.no_projects_available_text')); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('supervisor.layout.app_super', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/supervisor/dashboard.blade.php ENDPATH**/ ?>