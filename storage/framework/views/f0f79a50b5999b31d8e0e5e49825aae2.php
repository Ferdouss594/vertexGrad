...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('backend.supervisor_layout.default_title')); ?></title>

    <link rel="apple-touch-icon"
          href="<?php echo e(setting('platform_logo') ? asset('storage/' . setting('platform_logo')) : asset('vendors/images/apple-touch-icon.png')); ?>" />

    <link rel="icon"
          href="<?php echo e(setting('platform_favicon') ? asset('storage/' . setting('platform_favicon')) : asset('vendors/images/VertexGrad_logod.png')); ?>">

    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('vendors/styles/core.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('vendors/styles/icon-font.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('src/plugins/datatables/css/dataTables.bootstrap4.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('src/plugins/datatables/css/responsive.bootstrap4.min.css')); ?>" />
    ...
    <script>
        function showToast(message, type = 'success') {
            ...
            toast.innerHTML = message + `<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="<?php echo e(__('backend.common.close')); ?>"></button>`;
...
<div class="left-side-bar" id="supervisorSidebar">
    <div class="brand-logo">
        <a href="<?php echo e(route('supervisor.dashboard')); ?>" class="sidebar-logo-link">
            <img
                src="<?php echo e(!empty($adminUser?->profile_image) ? asset('storage/' . $adminUser->profile_image) : asset('vendors/images/photo1.jpg')); ?>"
                alt="<?php echo e(__('backend.supervisor_layout.user_avatar')); ?>"
                class="sidebar-account-avatar"
            >
        </a>

        <div class="close-sidebar" id="sidebarCloseBtn" title="<?php echo e(__('backend.supervisor_layout.close_sidebar')); ?>">
    ...
    <div class="menu-block">
        <div class="sidebar-menu">
            <div class="sidebar-section-label"><?php echo e(__('backend.supervisor_layout.supervisor_panel')); ?></div>

            <div class="sidebar-menu-scroll">
                <ul id="accordion-menu">
                    <li>
                        <a href="<?php echo e(route('supervisor.dashboard')); ?>"
                           class="<?php echo e(request()->routeIs('supervisor.dashboard') ? 'active' : ''); ?>">
                            <span class="micon bi bi-house-door-fill"></span>
                            <span class="mtext"><?php echo e(__('backend.supervisor_layout.dashboard')); ?></span>
                        </a>
                    </li>

                    <?php if($canReviewProjects): ?>
                        <?php $projectsOpen = request()->routeIs('supervisor.projects.*'); ?>
                        <li class="dropdown-parent <?php echo e($projectsOpen ? 'open active' : ''); ?>">
                            <div class="menu-dropdown-trigger">
                                <span class="micon bi bi-folder-fill"></span>
                                <span class="mtext"><?php echo e(__('backend.supervisor_layout.projects')); ?></span>
                                <span class="menu-arrow"><i class="fa fa-chevron-down"></i></span>
                            </div>
                            <ul class="submenu">
                                <li><a href="<?php echo e(route('supervisor.projects.index')); ?>" class="<?php echo e(request()->routeIs('supervisor.projects.index') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.all_projects')); ?></a></li>
                                <li><a href="<?php echo e(route('supervisor.projects.pending')); ?>" class="<?php echo e(request()->routeIs('supervisor.projects.pending') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.pending_reviews')); ?></a></li>
                                <li><a href="<?php echo e(route('supervisor.projects.approved')); ?>" class="<?php echo e(request()->routeIs('supervisor.projects.approved') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.approved_projects')); ?></a></li>
                                <li><a href="<?php echo e(route('supervisor.projects.revisions')); ?>" class="<?php echo e(request()->routeIs('supervisor.projects.revisions') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.revision_requests')); ?></a></li>
                            </ul>
                        </li>
                    <?php endif; ?>

                    <?php if($canViewMeetings): ?>
                        <?php $meetingsOpen = request()->routeIs('supervisor.meetings.*'); ?>
                        <li class="dropdown-parent <?php echo e($meetingsOpen ? 'open active' : ''); ?>">
                            <div class="menu-dropdown-trigger">
                                <span class="micon bi bi-calendar-event"></span>
                                <span class="mtext"><?php echo e(__('backend.supervisor_layout.meetings')); ?></span>
                                <span class="menu-arrow"><i class="fa fa-chevron-down"></i></span>
                            </div>
                            <ul class="submenu">
                                <li><a href="<?php echo e(route('supervisor.meetings.index')); ?>" class="<?php echo e(request()->routeIs('supervisor.meetings.index') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.all_meetings')); ?></a></li>
                                <li><a href="<?php echo e(route('supervisor.meetings.upcoming')); ?>" class="<?php echo e(request()->routeIs('supervisor.meetings.upcoming') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.upcoming_meetings')); ?></a></li>
                                <li><a href="<?php echo e(route('supervisor.meetings.completed')); ?>" class="<?php echo e(request()->routeIs('supervisor.meetings.completed') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.completed_meetings')); ?></a></li>
                                <?php if($canManageMeetings): ?>
                                    <li><a href="<?php echo e(route('supervisor.meetings.create')); ?>" class="<?php echo e(request()->routeIs('supervisor.meetings.create') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.create_meeting')); ?></a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if($canViewRequests): ?>
                        <?php $requestsOpen = request()->routeIs('supervisor.requests.*'); ?>
                        <li class="dropdown-parent <?php echo e($requestsOpen ? 'open active' : ''); ?>">
                            <div class="menu-dropdown-trigger">
                                <span class="micon fa fa-send"></span>
                                <span class="mtext"><?php echo e(__('backend.supervisor_layout.requests')); ?></span>
                                <span class="menu-arrow"><i class="fa fa-chevron-down"></i></span>
                            </div>
                            <ul class="submenu">
                                <li><a href="<?php echo e(route('supervisor.requests.index')); ?>" class="<?php echo e(request()->routeIs('supervisor.requests.index') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.all_requests')); ?></a></li>
                                <li><a href="<?php echo e(route('supervisor.requests.pending')); ?>" class="<?php echo e(request()->routeIs('supervisor.requests.pending') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.pending_requests')); ?></a></li>
                                <li><a href="<?php echo e(route('supervisor.requests.completed')); ?>" class="<?php echo e(request()->routeIs('supervisor.requests.completed') ? 'active' : ''); ?>"><?php echo e(__('backend.supervisor_layout.completed_requests')); ?></a></li>
                            </ul>
                        </li>
                    <?php endif; ?>

                    <?php if($user && $user->hasPermission('view_contact_messages')): ?>
                        <li>
                            <a href="<?php echo e(route('supervisor.contact-messages.index')); ?>"
                               class="<?php echo e(request()->routeIs('supervisor.contact-messages.*') ? 'active' : ''); ?>">
                                <span class="micon bi bi-envelope-paper-fill"></span>
                                <span class="mtext"><?php echo e(__('backend.supervisor_layout.contact_messages')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>

                    <li>
                        <a href="<?php echo e(route('supervisor.profile.index')); ?>"
                           class="<?php echo e(request()->routeIs('supervisor.profile.*') ? 'active' : ''); ?>">
                            <span class="micon bi bi-person-lines-fill"></span>
                            <span class="mtext"><?php echo e(__('backend.supervisor_layout.profile_settings')); ?></span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="sidebar-bottom">
                <div class="sidebar-bottom-title"><?php echo e(__('backend.supervisor_layout.account')); ?></div>
                ...
                <div class="sidebar-account-card">
                    <div class="sidebar-account-top">
                        ...
                        >
                        <div>
                            <div class="sidebar-account-name"><?php echo e($adminUser ? $adminUser->name : __('backend.supervisor_layout.guest')); ?></div>
                            <div class="sidebar-account-role"><?php echo e(__('backend.supervisor_layout.supervisor')); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="sidebar-account-links">
                        <a href="<?php echo e(route('supervisor.profile.index')); ?>">
                            ...
                            <span class="mtext"><?php echo e(__('backend.supervisor_layout.profile')); ?></span>
                        </a>
                        <a href="javascript:void(0);" id="rightSidebarToggleBtn">
                            <span class="micon bi bi-gear"></span>
                            <span class="mtext"><?php echo e(__('backend.supervisor_layout.layout_settings')); ?></span>
                        </a>
                    </div>
                </div>
            </div>
...
<div class="header">
    <div class="header-left">
        <div class="menu-icon bi bi-list" id="sidebarToggleBtn" title="<?php echo e(__('backend.supervisor_layout.toggle_sidebar')); ?>"></div>
        <div class="search-toggle-icon bi bi-grid" title="<?php echo e(__('backend.supervisor_layout.supervisor_panel')); ?>"></div>
    </div>

    <div class="header-right">
        <div class="language-switch-group">
            <a href="<?php echo e(route('admin.language.switch', 'en')); ?>"
               class="language-switch-btn <?php echo e($currentLocale === 'en' ? 'active' : ''); ?>"
               title="<?php echo e(__('backend.supervisor_layout.switch_to_english')); ?>">
                EN
            </a>
            <a href="<?php echo e(route('admin.language.switch', 'ar')); ?>"
               class="language-switch-btn <?php echo e($currentLocale === 'ar' ? 'active' : ''); ?>"
               title="<?php echo e(__('backend.supervisor_layout.switch_to_arabic')); ?>">
                AR
            </a>
        </div>

        <button type="button" class="theme-switch-btn" id="themeSwitchBtn" title="<?php echo e(__('backend.supervisor_layout.change_theme')); ?>">
            <i class="bi bi-moon-stars-fill" id="themeSwitchIcon"></i>
        </button>

        <a href="javascript:void(0);" class="header-setting-btn" id="headerRightSidebarToggleBtn" title="<?php echo e(__('backend.supervisor_layout.layout_settings')); ?>">
            <i class="dw dw-settings2"></i>
        </a>

        <div class="dropdown" id="admin-notification-bell" data-count-url="<?php echo e(route('admin.notifications.count')); ?>">
            <a class="dropdown-toggle position-relative d-inline-flex align-items-center justify-content-center text-decoration-none header-circle-btn"
               ...
               aria-expanded="false">
                ...
                <span id="adminUnreadBadge"
                      class="badge bg-danger rounded-circle d-flex align-items-center justify-content-center <?php echo e($unreadCount > 0 ? '' : 'd-none'); ?>"
            ...
            <div class="dropdown-menu dropdown-menu-end notification-panel">
                <div class="notification-panel-header">
                    <div>
                        <h6 class="notification-panel-title"><?php echo e(__('backend.supervisor_layout.notifications')); ?></h6>
                        <small class="notification-panel-count">
                            <span id="adminUnreadText"><?php echo e($unreadCount); ?></span> <?php echo e(__('backend.supervisor_layout.unread')); ?>
                ...
                <div class="notification-panel-body">
                    <?php $__empty_1 = true; $__currentLoopData = $latestNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <form method="POST" action="<?php echo e(route('admin.notifications.read', $notification->id)); ?>" class="m-0">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="redirect" value="<?php echo e($url); ?>">

                            <button type="submit" class="notification-item-btn <?php echo e($isRead ? '' : 'unread'); ?>">
                                <div class="d-flex align-items-start gap-3">
                                    <div class="notification-item-icon">
                                        <i class="<?php echo e($icon); ?>"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="notification-item-title"><?php echo e($title); ?></div>
                                        <div class="notification-item-message"><?php echo e($message); ?></div>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="px-3 py-4 text-center small" style="color: var(--vg-text-muted);">
                            <?php echo e(__('backend.supervisor_layout.no_notifications_yet')); ?>
                ...
                <div class="notification-panel-footer">
                    <a href="<?php echo e(route('admin.notifications.index')); ?>" class="notification-footer-btn">
                        <?php echo e(__('backend.supervisor_layout.history')); ?>

                    </a>

                    <form method="POST" action="<?php echo e(route('admin.notifications.markAllRead')); ?>" class="m-0">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="notification-footer-btn w-100">
                            <?php echo e(__('backend.supervisor_layout.mark_all_read')); ?>
        ...
        <div class="dropdown user-info-dropdown">
            <a class="dropdown-toggle d-flex align-items-center gap-2"
               ...
               aria-expanded="false">
                <img
                    src="<?php echo e(!empty($adminUser?->avatar) ? asset('storage/' . $adminUser->avatar) : asset('vendors/images/photo1.jpg')); ?>"
                    alt="<?php echo e(__('backend.supervisor_layout.user_avatar')); ?>"
                    class="sidebar-account-avatar"
                >
                <div class="d-none d-md-block text-start">
                    <div style="font-size: 13px; font-weight: 700; color: var(--vg-header-color); line-height: 1.2;">
                        <?php echo e($adminUser ? $adminUser->name : __('backend.supervisor_layout.guest')); ?>

                    </div>
                    <div style="font-size: 11px; color: var(--vg-text-muted); line-height: 1.2;">
                        <?php echo e(__('backend.supervisor_layout.supervisor')); ?>
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0" style="min-width: 230px;">
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('supervisor.profile.index')); ?>">
                        <i class="bi bi-person"></i>
                        <span><?php echo e(__('backend.supervisor_layout.profile')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0);" id="dropdownSettingsBtn">
                        <i class="bi bi-gear"></i>
                        <span><?php echo e(__('backend.supervisor_layout.layout_settings')); ?></span>
                    </a>
                </li>
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2 text-danger"
                       ...
                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        ...
                        <span><?php echo e(__('backend.supervisor_layout.log_out')); ?></span>
                    </a>
                </li>
            </ul>
...
<div class="right-sidebar" id="rightSidebarPanel">
    <div class="sidebar-title">
        <h3 class="weight-600 font-16">
            <?php echo e(__('backend.supervisor_layout.layout_settings')); ?>

            <span class="btn-block font-weight-400 font-12"><?php echo e(__('backend.supervisor_layout.supervisor_interface_preferences')); ?></span>
        </h3>
    ...
    <div class="right-sidebar-body customscroll">
        <div class="right-sidebar-body-content p-3">
            <div class="theme-setting-card">
                <div class="theme-setting-title"><?php echo e(__('backend.supervisor_layout.theme_mode')); ?></div>
                <div class="theme-btn-group">
                    <button type="button" class="theme-choice-btn" id="themeLightBtn"><?php echo e(__('backend.supervisor_layout.light')); ?></button>
                    <button type="button" class="theme-choice-btn" id="themeDarkBtn"><?php echo e(__('backend.supervisor_layout.dark')); ?></button>
                </div>
            </div>

            <div class="theme-setting-card">
                <div class="theme-setting-title"><?php echo e(__('backend.supervisor_layout.announcements')); ?></div>

                <?php if($layoutAnnouncements->count()): ?>
                    <div class="d-flex flex-column gap-3">
                        <?php $__currentLoopData = $layoutAnnouncements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="announcement-card">
                                <div class="d-flex align-items-start justify-content-between gap-2 mb-2">
                                    ...
                                    <?php if($announcement->is_pinned): ?>
                                        <span class="announcement-badge pinned">
                                            ...
                                            <?php echo e(__('backend.supervisor_layout.pinned')); ?>
                                ...
                                <p class="announcement-card-text">
                                    <?php echo e(\Illuminate\Support\Str::limit($announcement->body, 120)); ?>

                                </p>

                                <?php if($announcement->expires_at): ?>
                                    <div class="announcement-meta">
                                        <?php echo e(__('backend.supervisor_layout.until')); ?> <?php echo e($announcement->expires_at->format('M d, Y • h:i A')); ?>
                ...
                <?php else: ?>
                    <div class="announcement-card">
                        <div class="announcement-card-title"><?php echo e(__('backend.supervisor_layout.no_announcements')); ?></div>
                        <p class="announcement-card-text mb-0">
                            <?php echo e(__('backend.supervisor_layout.no_active_announcements')); ?>
            ...
            <div class="reset-options pt-2 text-center">
                <button class="btn btn-danger" id="reset-settings" type="button"><?php echo e(__('backend.supervisor_layout.reset_theme')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="main-container">
    ...
    <div class="app-footer">
        <div><strong><?php echo e(setting('platform_name', 'VertexGrad')); ?></strong> <?php echo e(__('backend.supervisor_layout.supervisor_panel')); ?></div>
        <div><?php echo e(setting('platform_tagline', __('backend.supervisor_layout.footer_tagline'))); ?></div>
    </div>
</div>
...
<script src="<?php echo e(asset('vendors/scripts/process.js')); ?>" defer></script>
<script src="<?php echo e(asset('src/plugins/apexcharts/apexcharts.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('src/plugins/datatables/js/jquery.dataTables.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('src/plugins/datatables/js/dataTables.bootstrap4.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('src/plugins/datatables/js/dataTables.responsive.min.js')); ?>" defer></script>
<script src="<?php echo e(asset('src/plugins/datatables/js/responsive.bootstrap4.min.js')); ?>" defer></script>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <?php if(session('error')): ?>
        showToast(<?php echo json_encode(session('error'), 15, 512) ?>, 'danger');
    <?php endif; ?>
...
</html><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/supervisor/layout/app_super.blade.php ENDPATH**/ ?>