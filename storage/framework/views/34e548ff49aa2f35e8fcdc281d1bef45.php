...
<head>
    ...
    <title><?php echo e(setting('platform_name', 'VertexGrad')); ?> - <?php echo $__env->yieldContent('title', __('backend.manager_layout.default_title')); ?></title>
...
<div class="header">
    <div class="header-left">
        <div class="menu-icon bi bi-list" data-toggle="left-sidebar-toggle" title="<?php echo e(__('backend.manager_layout.toggle_sidebar')); ?>"></div>
        <div class="search-toggle-icon bi bi-search" title="<?php echo e(__('backend.manager_layout.search')); ?>"></div>
    </div>
    ...
    <div class="header-right">
        <div class="language-switch-group">
            <a href="<?php echo e(route('admin.language.switch', 'en')); ?>"
               ...
               title="<?php echo e(__('backend.manager_layout.switch_to_english')); ?>">
                EN
            </a>
            <a href="<?php echo e(route('admin.language.switch', 'ar')); ?>"
               class="language-switch-btn <?php echo e($currentLocale === 'ar' ? 'active' : ''); ?>"
               title="<?php echo e(__('backend.manager_layout.switch_to_arabic')); ?>">
                AR
            </a>
        </div>

        <button type="button" class="theme-switch-btn" id="themeSwitchBtn" title="<?php echo e(__('backend.manager_layout.change_theme')); ?>">
        ...
        <div
            ...
            data-count-url="<?php echo e(route('admin.notifications.count')); ?>"
            data-latest-url="<?php echo e(route('admin.notifications.latest')); ?>"
        >
            ...
            <div class="dropdown-menu dropdown-menu-end p-0 border-0"
                ...
                <div class="d-flex justify-content-between align-items-center px-3 py-3"
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold" style="color: var(--vg-text);"><?php echo e(__('backend.manager_layout.notifications')); ?></h6>
                        <small style="color: var(--vg-text-muted);">
                            <span id="adminUnreadText"><?php echo e($unreadCount); ?></span> <?php echo e(__('backend.manager_layout.unread')); ?>
                ...
                <div id="adminNotificationList" style="max-height: 340px; overflow-y: auto; background: var(--vg-dropdown-bg);">
                    <?php $__empty_1 = true; $__currentLoopData = $latestNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <form method="POST" action="<?php echo e(route('admin.notifications.read', $notification->id)); ?>" class="m-0">
                            ...
                            <button type="submit"
                                    ...
                                    style="background: <?php echo e($isRead ? 'var(--vg-dropdown-bg)' : 'var(--vg-surface-soft)'); ?>; border-radius: 0; border-color: var(--vg-border) !important;">
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="fw-semibold small" style="color: var(--vg-text);"><?php echo e($title); ?></div>
                                        <div class="small mt-1" style="color: var(--vg-text-muted); line-height: 1.45;"><?php echo e($message); ?></div>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="px-3 py-4 text-center small" style="color: var(--vg-text-muted); background: var(--vg-dropdown-bg);">
                            <?php echo e(__('backend.manager_layout.no_notifications_yet')); ?>
                ...
                <div class="d-grid" style="grid-template-columns: 1fr 1fr; background: var(--vg-dropdown-bg);">
                    <a href="<?php echo e(route('admin.notifications.index')); ?>"
                       ...
                       style="border-top: 1px solid var(--vg-border); border-right: 1px solid var(--vg-border);">
                        <?php echo e(__('backend.manager_layout.history')); ?>
                    ...
                    <form method="POST" action="<?php echo e(route('admin.notifications.markAllRead')); ?>" class="m-0">
                        ...
                        <button type="submit"
                            ...
                            <?php echo e(__('backend.manager_layout.mark_all_read')); ?>
        ...
        <div class="dropdown user-info-dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end border-0" style="min-width: 230px;">
                <li><a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('admin.profile')); ?>"><i class="bi bi-person"></i><span><?php echo e(__('backend.manager_layout.profile')); ?></span></a></li>
                <li><a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('admin.settings.index')); ?>"><i class="bi bi-gear"></i><span><?php echo e(__('backend.manager_layout.settings')); ?></span></a></li>
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2 text-danger"
                       ...
                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        ...
                        <span><?php echo e(__('backend.manager_layout.log_out')); ?></span>
                    </a>
                </li>
            </ul>
...
<div class="left-side-bar">
    <div class="brand-logo">
        <a href="<?php echo e(route('manager.dashboard')); ?>" class="sidebar-logo-link">
            <img src="<?php echo e(setting('admin_logo') ? asset('storage/' . setting('admin_logo')) : (setting('platform_logo') ? asset('storage/' . setting('platform_logo')) : asset('vendors/images/VertexGrad_logod.png'))); ?>"
                 alt="<?php echo e(setting('platform_name', 'VertexGrad')); ?>"
                 class="sidebar-logo-img" />
        </a>

        <div class="close-sidebar" data-toggle="left-sidebar-close" title="<?php echo e(__('backend.manager_layout.close_sidebar')); ?>">
    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <div class="sidebar-section-label"><?php echo e(__('backend.manager_layout.main_navigation')); ?></div>

            <ul id="accordion-menu">
                <li>
                    <a href="<?php echo e(route('manager.dashboard')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('manager.dashboard') ? 'active' : ''); ?>">
                        <span class="micon bi bi-house-door-fill"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.dashboard')); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('manager.pending.users')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('manager.pending.users') ? 'active' : ''); ?>">
                        <span class="micon bi bi-people-fill"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.user_management')); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('manager.index')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('manager.index') ? 'active' : ''); ?>">
                        <span class="micon bi bi-person-workspace"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.managers')); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('admin.students.index')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.students.*') ? 'active' : ''); ?>">
                        <span class="micon bi bi-mortarboard-fill"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.students')); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('admin.investors.index')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.investors.*') ? 'active' : ''); ?>">
                        <span class="micon bi bi-wallet2"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.investors')); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('admin.investment-requests.index')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.investment-requests.*') ? 'active' : ''); ?>">
                        <span class="micon bi bi-cash-coin"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.investment_requests')); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('admin.projects.index')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.projects.*') ? 'active' : ''); ?>">
                        <span class="micon bi bi-briefcase-fill"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.projects')); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('admin.contact-messages.index')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.contact-messages.*') ? 'active' : ''); ?>">
                        <span class="micon bi bi-envelope-paper-fill"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.contact_messages')); ?></span>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('manager.calendar.index')); ?>"
                       class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('manager.calendar.*') ? 'active' : ''); ?>">
                        <span class="micon bi bi-calendar-check-fill"></span>
                        <span class="mtext"><?php echo e(__('backend.manager_layout.calendar')); ?></span>
                    </a>
                </li>

                <?php if(Route::has('admin.projects.final-decisions.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.projects.final-decisions.index')); ?>"
                           class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.projects.final-decisions.*') ? 'active' : ''); ?>">
                            <span class="micon bi bi-check2-square"></span>
                            <span class="mtext"><?php echo e(__('backend.manager_layout.final_decisions')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(Route::has('admin.reports.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.reports.index')); ?>"
                           class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.reports.*') ? 'active' : ''); ?>">
                            <span class="micon bi bi-bar-chart-line-fill"></span>
                            <span class="mtext"><?php echo e(__('backend.manager_layout.reports')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>

                <?php if(Route::has('admin.permissions.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.permissions.index')); ?>"
                           class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.permissions.*') ? 'active' : ''); ?>">
                            <span class="micon bi bi-shield-lock-fill"></span>
                            <span class="mtext"><?php echo e(__('backend.manager_layout.permissions')); ?></span>
                        </a>
                    </li>
 <?php endif; ?>
<?php if(Route::has('admin.auth-role-policies.index')): ?>
    <li>
        <a href="<?php echo e(route('admin.auth-role-policies.index')); ?>"
           class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.auth-role-policies.*') ? 'active' : ''); ?>">
            <span class="micon fa fa-shield-alt"></span>
            <span class="mtext"><?php echo e(__('backend.manager_layout.role_auth_policies')); ?></span>
        </a>
    </li>
<?php endif; ?>

<?php if(Route::has('admin.auth-policies.index')): ?>
    <li>
        <a href="<?php echo e(route('admin.auth-policies.index')); ?>"
           class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.auth-policies.*') ? 'active' : ''); ?>">
            <span class="micon fa fa-lock"></span>
            <span class="mtext"><?php echo e(__('backend.manager_layout.user_auth_policies')); ?></span>
        </a>
    </li>
<?php endif; ?>
                <?php if(Route::has('admin.announcements.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.announcements.index')); ?>"
                           class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.announcements.*') ? 'active' : ''); ?>">
                            <span class="micon bi bi-megaphone-fill"></span>
                            <span class="mtext"><?php echo e(__('backend.manager_layout.announcements')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>

                <?php if(Route::has('admin.audit-logs.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.audit-logs.index')); ?>"
                           class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('admin.audit-logs.*') ? 'active' : ''); ?>">
                            <span class="micon bi bi-clipboard-data-fill"></span>
                            <span class="mtext"><?php echo e(__('backend.manager_layout.audit_center')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(Route::has('settings.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.settings.index')); ?>"
                           class="dropdown-toggle no-arrow <?php echo e(request()->routeIs('settings.*') ? 'active' : ''); ?>">
                            <span class="micon bi bi-gear-fill"></span>
                            <span class="mtext"><?php echo e(__('backend.manager_layout.settings')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
            ...
            <div class="sidebar-bottom">
                <div class="sidebar-bottom-title"><?php echo e(__('backend.manager_layout.account')); ?></div>
                ...
                <div class="sidebar-account-card">
                    <div class="sidebar-account-top">
                        ...
                        >
                        <div>
                            <div class="sidebar-account-name"><?php echo e($adminUser ? $adminUser->name : __('backend.manager_layout.guest')); ?></div>
                            <div class="sidebar-account-role"><?php echo e(__('backend.manager_layout.administrator')); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="sidebar-account-links">
                        <a href="<?php echo e(route('admin.profile')); ?>">
                            ...
                            <span class="mtext"><?php echo e(__('backend.manager_layout.profile')); ?></span>
                        </a>
                        <a href="<?php echo e(route('admin.settings.index')); ?>">
...
<div class="main-container">
    ...
    <div class="app-footer">
        <div><strong><?php echo e(setting('platform_name', 'VertexGrad')); ?></strong> <?php echo e(__('backend.manager_layout.manager_panel')); ?></div>
        <div><?php echo e(setting('platform_tagline', __('backend.manager_layout.footer_tagline'))); ?></div>
    </div>
</div>
...
</html><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/layouts/app.blade.php ENDPATH**/ ?>