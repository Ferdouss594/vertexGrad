...
<div class="min-h-screen pt-28 pb-12 bg-theme-bg transition-colors duration-300">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div class="relative">
                <h1 class="text-4xl md:text-6xl font-black text-theme-text tracking-tight">
                    <?php echo e(__('frontend.academic_dashboard.welcome')); ?>,
                    <span class="text-brand-accent"><?php echo e(explode(' ', $user->name)[0]); ?></span>
                </h1>
                <p class="text-theme-muted mt-3 flex items-center tracking-[0.2em] uppercase text-xs font-bold">
                    ...
                    <?php echo e(__('frontend.academic_dashboard.researcher_identity')); ?>: <?php echo e($user->id + 5000); ?>

                </p>
            </div>

            <div class="flex flex-wrap items-center gap-3">
                <a href="<?php echo e(route('settings.academic')); ?>" class="<?php echo e($btnSecondaryClass); ?>">
                    <i class="fas fa-cog mr-2"></i> <?php echo e(__('frontend.academic_dashboard.settings', [], app()->getLocale())); ?>

                </a>

                <a href="<?php echo e(route('project.submit.step1')); ?>" class="<?php echo e($btnPrimaryClass); ?>">
                    <i class="fas fa-rocket mr-2"></i> <?php echo e(__('frontend.academic_dashboard.submit_new_research')); ?>
            ...
            <section id="announcementSection" class="mb-8">
                <div class="relative overflow-hidden rounded-[2rem] theme-panel shadow-brand-soft">
                    <div class="relative z-10 p-5 md:p-7">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex flex-wrap items-center gap-2 mb-3">
                                    <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-theme-surface-2 text-theme-muted border border-theme-border text-[11px] font-black uppercase tracking-[0.16em]">
                                        <?php echo e(__('frontend.academic_dashboard.announcement')); ?>

                                    </span>

                                    <?php if($featuredAnnouncement->is_pinned): ?>
                                        <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-amber-400/10 text-amber-500 border border-amber-400/20 text-[11px] font-black uppercase tracking-[0.16em]">
                                            ...
                                            <?php echo e(__('frontend.academic_dashboard.pinned')); ?>

                                        </span>
                                    <?php endif; ?>

                                    <?php if($featuredAnnouncement->expires_at): ?>
                                        <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-red-500/10 text-red-500 border border-red-500/20 text-[11px] font-black uppercase tracking-[0.16em]">
                                            ...
                                            <?php echo e(__('frontend.academic_dashboard.until')); ?> <?php echo e($featuredAnnouncement->expires_at->format('M d, Y • h:i A')); ?>
                                ...
                                <h2 class="text-xl md:text-2xl font-black text-theme-text leading-tight mb-2">
                                    <?php echo e($featuredAnnouncement->title); ?>

                                </h2>

                                <p class="text-theme-muted text-sm md:text-[15px] leading-7 max-w-4xl">
                                    <?php echo e($featuredAnnouncement->body); ?>
                        ...
                        <?php if($otherAnnouncements->count()): ?>
                            <div class="mt-5 pt-5 border-t border-theme-border">
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    <?php $__currentLoopData = $otherAnnouncements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="rounded-[1.5rem] border border-theme-border bg-theme-surface-2 transition p-4">
                                            ...
                                            <p class="text-theme-muted text-sm leading-6">
                                                <?php echo e(\Illuminate\Support\Str::limit($announcement->body, 160)); ?>

                                            </p>

                                            <?php if($announcement->expires_at): ?>
                                                <div class="mt-3 text-[11px] text-red-500 font-semibold">
                                                    <?php echo e(__('frontend.academic_dashboard.visible_until')); ?> <?php echo e($announcement->expires_at->format('M d, Y • h:i A')); ?>
        ...
        <?php if($errors->any()): ?>
            <div class="max-w-6xl mx-auto px-4 mb-6">
                <div class="p-4 rounded-xl border border-red-500/40 bg-red-500/10 text-red-600">
                    <div class="font-bold mb-2"><?php echo e(__('frontend.academic_dashboard.please_review_following')); ?></div>
        ...
        <?php if($currentProject && !$currentDecision && $currentProject->status === 'pending'): ?>
            <div class="max-w-6xl mx-auto px-4 mb-6">
                <div class="p-4 rounded-xl border border-yellow-500/40 bg-yellow-500/10 text-yellow-700">
                    <?php echo __('frontend.academic_dashboard.project_pending_review', ['name' => e($currentProject->name)]); ?>

                </div>
            </div>
        <?php endif; ?>

        <?php if($currentProject && $currentDecision === 'rejected'): ?>
            <div class="max-w-6xl mx-auto px-4 mb-6">
                <div class="p-4 rounded-xl border border-red-500/40 bg-red-500/10 text-red-600">
                    <?php echo __('frontend.academic_dashboard.project_rejected', ['name' => e($currentProject->name)]); ?>

                </div>
            </div>
        <?php endif; ?>

        <?php if($currentProject && $currentDecision === 'revision_requested'): ?>
            <div class="max-w-6xl mx-auto px-4 mb-6">
                <div class="p-4 rounded-xl border border-yellow-500/40 bg-yellow-500/10 text-yellow-700">
                    <?php echo __('frontend.academic_dashboard.project_revision_requested', ['name' => e($currentProject->name)]); ?>

                </div>
            </div>
        <?php endif; ?>

        <?php if($currentProject && $currentDecision === 'published'): ?>
            <div class="max-w-6xl mx-auto px-4 mb-6">
                <div class="p-4 rounded-xl border border-green-500/40 bg-green-500/10 text-green-700">
                    <?php echo __('frontend.academic_dashboard.project_published', ['name' => e($currentProject->name)]); ?>

                </div>
            </div>
        <?php endif; ?>

        <?php if($currentProject && !$currentDecision && in_array($currentProject->status, $mediaUploadAllowedStatuses)): ?>
            <div class="max-w-6xl mx-auto px-4 mb-6">
                <div class="p-4 rounded-xl border border-green-500/40 bg-green-500/10 text-green-700">
                    <?php echo __('frontend.academic_dashboard.project_approved_upload_media', ['name' => e($currentProject->name)]); ?>
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-6 flex-wrap">
                                <span class="px-4 py-1.5 rounded-xl bg-brand-accent-soft text-brand-accent text-[10px] font-black uppercase tracking-[0.15em] border border-brand-accent">
                                    <?php echo e($currentProject->category ?? __('frontend.academic_dashboard.uncategorized')); ?>

                                </span>
                                <span class="text-theme-muted text-xs font-mono">REF: PRJ-<?php echo e($currentProject->project_id + 1000); ?></span>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
                                <div class="theme-panel-soft p-4 rounded-2xl">
                                    <p class="text-theme-muted text-[10px] uppercase font-black mb-1 tracking-widest"><?php echo e(__('frontend.academic_dashboard.target_budget')); ?></p>
                                    <p class="text-2xl font-bold text-green-600">$<?php echo e(number_format($currentProject->budget ?? 0)); ?></p>
                                </div>

                                <div class="theme-panel-soft p-4 rounded-2xl">
                                    <p class="text-theme-muted text-[10px] uppercase font-black mb-1 tracking-widest"><?php echo e(__('frontend.academic_dashboard.submission_date')); ?></p>
                                    <p class="text-xl text-theme-text font-semibold"><?php echo e($currentProject->created_at->format('M d, Y')); ?></p>
                                </div>

                                <div class="theme-panel-soft p-4 rounded-2xl">
                                    <p class="text-theme-muted text-[10px] uppercase font-black mb-1 tracking-widest"><?php echo e(__('frontend.academic_dashboard.final_decision')); ?></p>
                                    <div class="flex items-center gap-2 mt-1">
                                        ...
                                        <span class="text-lg font-bold text-theme-text italic">
                                            <?php echo e($decisionLabel($currentDecision) ?? ($currentProject->status == 'pending' ? __('frontend.academic_dashboard.reviewing') : ucfirst($currentProject->status))); ?>
                            ...
                            <div class="mt-10">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-xs font-black text-theme-text uppercase tracking-[0.25em] flex items-center gap-3">
                                        <i class="fas fa-photo-video text-brand-accent"></i> <?php echo e(__('frontend.academic_dashboard.media_preview')); ?>

                                    </h3>
                                    <div class="text-xs text-theme-muted font-mono">
                                        <?php echo e(__('frontend.academic_dashboard.images')); ?>: <?php echo e($currentImages->count()); ?> • <?php echo e(__('frontend.academic_dashboard.video')); ?>: <?php echo e($currentVideoUrl ? __('frontend.academic_dashboard.yes') : __('frontend.academic_dashboard.no')); ?>

                                    </div>
                                </div>

                                <?php if($currentImages->count() > 0): ?>
                                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                        <?php $__currentLoopData = $currentImages->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <a href="<?php echo e($m->getUrl()); ?>" target="_blank"
   class="project-preview-link relative overflow-hidden rounded-2xl border border-theme-border bg-theme-surface-2 transition">   <img src="<?php echo e($m->getUrl()); ?>" class="w-full h-28 object-cover" alt="<?php echo e(__('frontend.academic_dashboard.project_image')); ?>">
                                            </a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php else: ?>
                                    <div class="p-5 rounded-2xl border border-theme-border bg-theme-surface-2 text-theme-muted text-sm">
                                        <?php echo e(__('frontend.academic_dashboard.no_images_uploaded')); ?>
                                ...
                                <?php if($currentVideoUrl): ?>
                                    <button type="button"
                                            onclick="openVideoModal('<?php echo e($currentVideoUrl); ?>')"
                                        ...
                                        <span class="font-bold text-xs uppercase tracking-wider"><?php echo e(__('frontend.academic_dashboard.play_video')); ?></span>
                        ...
                        <div class="flex flex-col justify-center gap-4 min-w-[260px]">
                            <a href="<?php echo e(route('frontend.projects.show', $currentProject->project_id)); ?>"
                               class="group/btn flex items-center justify-between p-5 bg-brand-accent text-white rounded-2xl transition-all hover:bg-brand-accent-strong">
                                <span class="font-black uppercase text-xs tracking-wider"><?php echo e(__('frontend.academic_dashboard.project_portfolio')); ?></span>
                                <i class="fas fa-arrow-right group-hover/btn:translate-x-1 transition-transform"></i>
                            </a>

                            <?php if(in_array($currentDecision, $mediaUploadAllowedDecisions) || (!$currentDecision && in_array($currentProject->status, $mediaUploadAllowedStatuses))): ?>
                                <button type="button"
                                        onclick="openUploadModal('<?php echo e(route('projects.media.upload', $currentProject->project_id)); ?>')"
                                    ...
                                    <span class="font-bold text-xs uppercase tracking-wider"><?php echo e(__('frontend.academic_dashboard.upload_project_media')); ?></span>
                            ...
                            <?php else: ?>
                                <div class="flex items-center justify-between p-2 bg-theme-surface-2 border border-theme-border rounded-2xl text-theme-muted opacity-90">
                                    <div>
                                        <span class="block font-bold text-xs uppercase tracking-wider mb-1"><?php echo e(__('frontend.academic_dashboard.upload_locked')); ?></span>
                                        <span class="text-xs opacity-80">
                                            <?php echo e(__('frontend.academic_dashboard.upload_locked_text')); ?>
                            ...
                            <?php if(in_array($scanState, ['draft', 'scan_failed', 'scan_requested', 'pending', 'rejected'])): ?>
                                <?php
                                ...
                                <a href="http://127.0.0.1:8000/submit?data=<?php echo e(urlencode($scanData)); ?>"
                                   class="flex items-center justify-between p-2 bg-blue-600 text-white rounded-2xl transition-all hover:bg-blue-700 group">
                                    <div>
                                        <span class="block font-black uppercase text-xs tracking-wider">
                                            <?php echo e(__('frontend.academic_dashboard.technical_scan')); ?>

                                        </span>
                                        <span class="text-xs opacity-80">
                                            <?php echo e(__('frontend.academic_dashboard.scan_now_question')); ?>
                            ...
                            <?php elseif(in_array($scanState, ['scan_completed', 'awaiting_manual_review', 'approved', 'published', 'active'])): ?>
                                <?php
                                    $scanData = base64_encode(json_encode([
                                        'platform_project_id' => $currentProject->project_id,
                                        'project_name' => $currentProject->name,
                                ...
                                <a href="http://127.0.0.1:8000/submit?data=<?php echo e(urlencode($scanData)); ?>"
                                   class="flex items-center justify-between p-2 bg-green-600 text-white rounded-2xl hover:bg-green-700 transition group">
                                    <div>
                                        ...
                                        <span class="text-xs opacity-80">
                                            <?php echo e(__('frontend.academic_dashboard.scan_completed_open_workspace')); ?>
                ...
                <div class="h-1.5 w-full bg-theme-surface-2">
                    <div class="h-full bg-brand-accent transition-all duration-1000" style="width: <?php echo e($progress); ?>%"></div>
                </div>
            </div>
            ...
            <section class="mb-12">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-black text-theme-text uppercase tracking-[0.2em] flex items-center gap-3">
                        <i class="fas fa-inbox text-brand-accent"></i> <?php echo e(__('frontend.academic_dashboard.supervisor_requests')); ?>

                    </h2>
                    <div class="text-xs text-theme-muted font-mono">
                        <?php echo e(__('frontend.academic_dashboard.total')); ?>: <?php echo e($currentRequests->count()); ?>

                    </div>
                </div>

                <?php if($currentRequests->count() > 0): ?>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <?php $__currentLoopData = $currentRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requestItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="theme-panel rounded-[2rem] p-6">
                                <div class="flex items-start justify-between gap-4 mb-4">
                                    <div>
                                        <div class="text-theme-text text-lg font-black mb-1"><?php echo e($requestItem->title); ?></div>
                                    ...
                                    <span class="px-3 py-1 rounded-xl text-[10px] font-black uppercase tracking-[0.15em] border <?php echo e($statusClasses); ?>">
                                ...
                                <div class="text-theme-muted text-sm leading-relaxed mb-4 whitespace-pre-line">
                                    <?php echo e($requestItem->description ?: __('frontend.academic_dashboard.no_additional_details')); ?>

                                </div>

                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5 text-sm">
                                    <div class="theme-panel-soft rounded-2xl p-4">
                                        <div class="text-theme-muted text-[10px] uppercase font-black tracking-widest mb-1"><?php echo e(__('frontend.academic_dashboard.supervisor')); ?></div>
                                        <div class="text-theme-text font-semibold"><?php echo e($requestItem->supervisor->name ?? __('frontend.academic_dashboard.supervisor_fallback')); ?></div>
                                    </div>

                                    <div class="theme-panel-soft rounded-2xl p-4">
                                        <div class="text-theme-muted text-[10px] uppercase font-black tracking-widest mb-1"><?php echo e(__('frontend.academic_dashboard.due_date')); ?></div>
                                        <div class="text-theme-text font-semibold">
                                            <?php echo e($requestItem->due_date ? \Carbon\Carbon::parse($requestItem->due_date)->format('M d, Y') : __('frontend.academic_dashboard.not_specified')); ?>
                                ...
                                <?php if($requestItem->latestResponse): ?>
                                    <div class="mb-5 p-4 rounded-2xl border border-green-500/20 bg-green-500/5">
                                        <div class="text-green-600 text-xs font-black uppercase tracking-[0.15em] mb-2">
                                            <?php echo e(__('frontend.academic_dashboard.latest_response_sent')); ?>
                                        ...
                                        <div class="flex flex-wrap gap-3">
                                            <?php if($requestItem->latestResponse->response_link): ?>
                                                <a href="<?php echo e($requestItem->latestResponse->response_link); ?>" target="_blank"
                                                   class="text-brand-accent text-sm font-bold hover:underline">
                                                    <?php echo e(__('frontend.academic_dashboard.open_submitted_link')); ?>

                                                </a>
                                            <?php endif; ?>

                                            <?php if($requestItem->latestResponse->attachment_path): ?>
                                                <a href="<?php echo e(asset('storage/' . $requestItem->latestResponse->attachment_path)); ?>" target="_blank"
                                                   class="text-cyan-600 text-sm font-bold hover:underline">
                                                    <?php echo e(__('frontend.academic_dashboard.download_attachment')); ?>
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <button type="button"
                                            onclick="openRequestResponseModal(
                                                '<?php echo e(route('student.requests.respond', $requestItem->id)); ?>',
                                                <?php echo \Illuminate\Support\Js::from($requestItem->title)->toHtml() ?>,
                                                <?php echo \Illuminate\Support\Js::from($requestType)->toHtml() ?>
                                            )"
                                        ...
                                        <?php echo e($requestItem->latestResponse ? __('frontend.academic_dashboard.update_and_send') : __('frontend.academic_dashboard.send_to_supervisor')); ?>
                ...
                <?php else: ?>
                    <div class="theme-panel rounded-[2rem] p-10 text-center text-theme-muted">
                        <?php echo e(__('frontend.academic_dashboard.no_supervisor_requests')); ?>
            ...
            <section class="mb-12">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-black text-theme-text uppercase tracking-[0.2em] flex items-center gap-3">
                        <i class="fas fa-calendar-alt text-brand-accent"></i> <?php echo e(__('frontend.academic_dashboard.meetings_demo_sessions')); ?>

                    </h2>
                    <div class="text-xs text-theme-muted font-mono">
                        <?php echo e(__('frontend.academic_dashboard.total')); ?>: <?php echo e($currentMeetings->count()); ?>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <?php $__currentLoopData = $currentMeetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="theme-panel rounded-[2rem] p-6">
                                <div class="flex items-start justify-between gap-4 mb-4">
                                    <div>
                                        <div class="text-theme-text text-lg font-black mb-1"><?php echo e($meeting->title); ?></div>
                                        <div class="text-theme-muted text-xs uppercase tracking-[0.15em] font-bold">
                                            <?php echo e(ucfirst($meeting->meeting_type)); ?>

                                        </div>
                                    </div>

                                    <span class="px-3 py-1 rounded-xl text-[10px] font-black uppercase tracking-[0.15em] border <?php echo e($meetingStatusClasses); ?>">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5 text-sm">
                                    <div class="theme-panel-soft rounded-2xl p-4">
                                        <div class="text-theme-muted text-[10px] uppercase font-black tracking-widest mb-1"><?php echo e(__('frontend.academic_dashboard.meeting_date')); ?></div>
                                        <div class="text-theme-text font-semibold">
                                            <?php echo e($meeting->meeting_date ? \Carbon\Carbon::parse($meeting->meeting_date)->format('M d, Y') : __('frontend.academic_dashboard.not_set')); ?>

                                        </div>
                                    </div>

                                    <div class="theme-panel-soft rounded-2xl p-4">
                                        <div class="text-theme-muted text-[10px] uppercase font-black tracking-widest mb-1"><?php echo e(__('frontend.academic_dashboard.meeting_time')); ?></div>
                                        <div class="text-theme-text font-semibold">
                                            <?php echo e($meeting->meeting_time ? \Carbon\Carbon::parse($meeting->meeting_time)->format('h:i A') : __('frontend.academic_dashboard.not_set')); ?>
                                ...
                                <?php if($meeting->notes): ?>
                                    <div class="mb-4 p-4 rounded-2xl border border-theme-border bg-theme-surface-2">
                                        <div class="text-theme-muted text-[10px] uppercase font-black tracking-widest mb-2"><?php echo e(__('frontend.academic_dashboard.meeting_notes')); ?></div>
                                        <div class="text-theme-text text-sm whitespace-pre-line"><?php echo e($meeting->notes); ?></div>
                                    </div>
                                <?php endif; ?>
                                    ...
                                    <?php if($meeting->meeting_link): ?>
                                        <a href="<?php echo e($meeting->meeting_link); ?>" target="_blank"
                                           class="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-green-500 text-white font-black hover:bg-green-600 transition shadow-brand-soft">
                                            ...
                                            <?php echo e(__('frontend.academic_dashboard.join_meeting')); ?>
                ...
                <?php else: ?>
                    <div class="theme-panel rounded-[2rem] p-10 text-center text-theme-muted">
                        <?php echo e(__('frontend.academic_dashboard.no_meetings')); ?>
            ...
            <section class="mb-12">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-black text-theme-text uppercase tracking-[0.2em] flex items-center gap-3">
                        <i class="fas fa-layer-group text-brand-accent"></i> <?php echo e(__('frontend.academic_dashboard.your_projects')); ?>

                    </h2>
                    <div class="text-xs text-theme-muted font-mono"><?php echo e(__('frontend.academic_dashboard.total')); ?>: <?php echo e($projects->count()); ?></div>
                </div>
   ...
   class="block rounded-[2rem] overflow-hidden transition border <?php echo e($active ? 'border-brand-accent shadow-brand-soft' : 'border-theme-border theme-panel hover:border-brand-accent/40'); ?>">  <div class="h-44 bg-theme-surface-2 relative">
                                <?php if($thumb): ?>
                                    <img src="<?php echo e($thumb); ?>" class="w-full h-full object-cover" alt="<?php echo e(__('frontend.academic_dashboard.project_thumbnail')); ?>">
                                <?php else: ?>
                                    <div class="w-full h-full flex items-center justify-center text-theme-muted">
                                        <div class="text-center">
                                            <i class="fas fa-image text-3xl mb-2"></i>
                                            <div class="text-xs uppercase tracking-[0.2em] font-black"><?php echo e(__('frontend.academic_dashboard.no_image')); ?></div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="absolute top-4 left-4 flex gap-2">
                                    <span class="px-3 py-1 rounded-xl bg-brand-accent-soft text-brand-accent text-[10px] font-black uppercase tracking-[0.15em] border border-brand-accent">
                                        <?php echo e($project->category ?? __('frontend.academic_dashboard.general')); ?>
                                    ...
                                    <?php if($hasVideo): ?>
                                        <span class="px-3 py-1 rounded-xl bg-theme-surface text-theme-text text-[10px] font-black uppercase tracking-[0.15em] border border-theme-border">
                                            <?php echo e(__('frontend.academic_dashboard.video')); ?>
                            ...
                            <div class="p-6">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-theme-muted text-xs font-mono">PRJ-<?php echo e($project->project_id + 1000); ?></span>
                                    <span class="text-theme-muted text-xs font-mono"><?php echo e($project->created_at?->format('M d, Y')); ?></span>
                                </div>

                                <h3 class="text-theme-text text-lg font-black leading-tight mb-3">
                                    <?php echo e(\Illuminate\Support\Str::limit($project->name, 60)); ?>

                                </h3>

                                <div class="flex items-center justify-between text-sm">
                                    <div class="text-theme-muted">
                                        <span><?php echo e(__('frontend.academic_dashboard.images')); ?>:</span> <span class="font-bold text-theme-text"><?php echo e($imgCount); ?></span>
                                    </div>
                                    <div class="text-theme-muted">
                                        <span><?php echo e(__('frontend.academic_dashboard.status')); ?>:</span>
                                        <span class="font-bold text-theme-text">
                                            <?php echo e($decisionLabel($projectDecision) ?? ($project->status === 'pending' ? __('frontend.academic_dashboard.reviewing') : ucfirst($project->status))); ?>
        ...
        <?php else: ?>
            <div class="theme-panel rounded-[3rem] p-20 text-center mb-12">
                ...
                <h2 class="text-3xl font-bold text-theme-text mb-3"><?php echo e(__('frontend.academic_dashboard.no_active_research')); ?></h2>
                <p class="text-theme-muted mb-10 max-w-lg mx-auto leading-relaxed">
                    <?php echo e(__('frontend.academic_dashboard.no_active_research_text')); ?>

                </p>
                <a href="<?php echo e(route('project.submit.step1')); ?>" class="<?php echo e($btnPrimaryClass); ?>">
                    <?php echo e(__('frontend.academic_dashboard.start_submission')); ?>
        ...
        <div class="min-h-full flex items-start justify-center px-4 py-10">
            <div class="w-full max-w-4xl theme-panel rounded-[2rem] overflow-hidden">
                <div class="p-5 border-b border-theme-border flex items-center justify-between">
                    <div class="text-theme-text font-black"><?php echo e(__('frontend.academic_dashboard.project_video')); ?></div>
    ...
    <div class="relative z-10 h-full overflow-y-auto">
        <div class="min-h-full flex items-start justify-center px-4 py-10">
            <div class="w-full max-w-2xl theme-panel rounded-[2rem] overflow-hidden">
                <div class="p-5 border-b border-theme-border flex items-center justify-between">
                    <div>
                        <div class="text-theme-text font-black"><?php echo e(__('frontend.academic_dashboard.upload_data')); ?></div>
                        <div class="text-theme-muted text-xs font-mono"><?php echo e(__('frontend.academic_dashboard.add_images_video')); ?></div>
                    </div>
                ...
                <form id="uploadForm" class="p-6 space-y-5" method="POST" enctype="multipart/form-data" action="">
                    ...
                    <div class="theme-panel-soft p-4 rounded-2xl">
                        <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.add_photos_multiple')); ?></label>
                    ...
                    <div class="theme-panel-soft p-4 rounded-2xl">
                        <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.add_video_single')); ?></label>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-2">
                        <button type="button" onclick="closeUploadModal()"
                            ...
                            <?php echo e(__('frontend.academic_dashboard.cancel')); ?>
                        ...
                        <button type="submit" class="px-6 py-3 rounded-2xl bg-brand-accent text-white font-black hover:bg-brand-accent-strong transition">
                            <?php echo e(__('frontend.academic_dashboard.upload_now')); ?>
    ...
    <div class="relative z-10 h-full overflow-y-auto">
        <div class="min-h-full flex items-start justify-center px-4 py-10">
            <div class="w-full max-w-3xl theme-panel rounded-[2rem] overflow-hidden">
                <div class="p-5 border-b border-theme-border flex items-center justify-between">
                    <div>
                        <div class="text-theme-text font-black" id="requestResponseModalTitle"><?php echo e(__('frontend.academic_dashboard.send_response_to_supervisor')); ?></div>
                        <div class="text-theme-muted text-xs font-mono" id="requestResponseModalSubtitle"><?php echo e(__('frontend.academic_dashboard.submit_text_link_attachment')); ?></div>
                    </div>
                ...
                <form id="requestResponseForm" class="p-6 space-y-5" method="POST" enctype="multipart/form-data" action="">
                    ...
                    <div id="normalRequestFields" class="space-y-5">
                        <div class="theme-panel-soft p-4 rounded-2xl">
                            <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.response_text')); ?></label>
                            <textarea id="normal_response_text" rows="5"
                                      ...
                                      placeholder="<?php echo e(__('frontend.academic_dashboard.write_response_here')); ?>"></textarea>
                        </div>

                        <div class="theme-panel-soft p-4 rounded-2xl">
                            <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.response_link')); ?></label>
                            <input type="url" id="normal_response_link"
                                   class="w-full p-3 rounded-xl border border-theme-border bg-theme-surface text-theme-text"
                                   placeholder="<?php echo e(__('frontend.academic_dashboard.response_link_placeholder')); ?>">
                        </div>
                    </div>
                    ...
                    <div id="systemVerificationFields" class="hidden space-y-5">
                        <div class="bg-brand-accent-soft border border-brand-accent rounded-2xl p-4 text-theme-text text-sm">
                            <?php echo __('frontend.academic_dashboard.fill_at_least_four'); ?>

                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="theme-panel-soft p-4 rounded-2xl">
                                <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.frontend_url')); ?></label>
                            ...
                            <div class="theme-panel-soft p-4 rounded-2xl">
                                <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.backend_url')); ?></label>
                            ...
                            <div class="theme-panel-soft p-4 rounded-2xl">
                                <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.api_health_url')); ?></label>
                            ...
                            <div class="theme-panel-soft p-4 rounded-2xl">
                                <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.admin_panel_url')); ?></label>
                            ...
                            <div class="theme-panel-soft p-4 rounded-2xl">
                                <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.demo_account')); ?></label>
                            ...
                            <div class="theme-panel-soft p-4 rounded-2xl">
                                <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.demo_password')); ?></label>
                                <input type="text" id="sv_demo_password" class="w-full p-3 rounded-xl border border-theme-border bg-theme-surface text-theme-text" placeholder="<?php echo e(__('frontend.academic_dashboard.password_plain')); ?>">
                            </div>
                        </div>

                        <div class="theme-panel-soft p-4 rounded-2xl">
                            <label class="block text-sm font-bold text-theme-text mb-2"><?php echo e(__('frontend.academic_dashboard.deployment_notes')); ?></label>
                            <textarea id="sv_deployment_notes" rows="5"
                                      class="w-full p-3 rounded-xl border border-theme-border bg-theme-surface text-theme-text"
                                      placeholder="<?php echo e(__('frontend.academic_dashboard.deployment_notes_placeholder')); ?>"></textarea>
                        </div>
                    </div>

                    <div class="theme-panel-soft p-4 rounded-2xl">
                        <label class="block text-sm font-bold text-theme-text mb-3"><?php echo e(__('frontend.academic_dashboard.attachment')); ?></label>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
                            ...
                            <button type="button"
                                ...
                                <i class="fas fa-paper-plane"></i>
                                <?php echo e(__('frontend.academic_dashboard.send_now')); ?>

                            </button>
                        </div>

                        <div class="text-theme-muted text-xs mt-2">
                            <?php echo e(__('frontend.academic_dashboard.allowed_attachment_types')); ?>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-2">
                        ...
                        <button type="button"
                            ...
                            <i class="fas fa-paper-plane"></i>
                            <?php echo e(__('frontend.academic_dashboard.send_to_supervisor')); ?>
...
<script>
    ...
    function openRequestResponseModal(actionUrl, title, requestType) {
        ...
        if (isSystemVerification) {
            ...
            titleEl.textContent = '<?php echo e(__('frontend.academic_dashboard.complete_system_verification_request')); ?>: ' + title;
            subtitleEl.textContent = '<?php echo e(__('frontend.academic_dashboard.provide_technical_details')); ?>';
            ...
            titleEl.textContent = '<?php echo e(__('frontend.academic_dashboard.send_response_to_supervisor')); ?>: ' + title;
            subtitleEl.textContent = '<?php echo e(__('frontend.academic_dashboard.submit_text_link_attachment')); ?>';
    ...
    function submitRequestResponseForm() {
        ...
        if (currentRequestMode === 'system') {
            ...
            if (filledCount < 4) {
                alert('<?php echo e(__('frontend.academic_dashboard.fill_four_alert')); ?>');
                return;
            }

            generatedText.value =
`<?php echo e(__('frontend.academic_dashboard.system_verification_response')); ?>


<?php echo e(__('frontend.academic_dashboard.frontend_url')); ?>: ${frontendUrl || '<?php echo e(__('frontend.academic_dashboard.not_provided')); ?>'}
<?php echo e(__('frontend.academic_dashboard.backend_url')); ?>: ${backendUrl || '<?php echo e(__('frontend.academic_dashboard.not_provided')); ?>'}
<?php echo e(__('frontend.academic_dashboard.api_health_url')); ?>: ${apiHealthUrl || '<?php echo e(__('frontend.academic_dashboard.not_provided')); ?>'}
<?php echo e(__('frontend.academic_dashboard.admin_panel_url')); ?>: ${adminPanelUrl || '<?php echo e(__('frontend.academic_dashboard.not_provided')); ?>'}
<?php echo e(__('frontend.academic_dashboard.demo_account')); ?>: ${demoAccount || '<?php echo e(__('frontend.academic_dashboard.not_provided')); ?>'}
<?php echo e(__('frontend.academic_dashboard.demo_password')); ?>: ${demoPassword || '<?php echo e(__('frontend.academic_dashboard.not_provided')); ?>'}

<?php echo e(__('frontend.academic_dashboard.deployment_notes')); ?>:
${deploymentNotes || '<?php echo e(__('frontend.academic_dashboard.no_deployment_notes')); ?>'}`;
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MC\Desktop\ضروري\vertex_system\resources\views/frontend/dashboard/academic.blade.php ENDPATH**/ ?>