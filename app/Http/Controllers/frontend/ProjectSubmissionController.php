...
class ProjectSubmissionController extends Controller
{
    ...
    */
    ...
    public function postStep3(Request $request)
    {
       ...
       'requested_amount' => 'required_if:needs_funding,yes|nullable|numeric|min:0',
'support_type' => 'required_if:needs_funding,yes|nullable|string|max:100',
'budget_breakdown' => 'required_if:needs_funding,yes|nullable|string',
            'milestone_1' => 'nullable|string|max:255',
        'milestone_1_month' => 'nullable|integer|min:1|max:60',
        'milestone_2' => 'nullable|string|max:255',
        'milestone_2_month' => 'nullable|integer|min:1|max:60',
        'milestone_3' => 'nullable|string|max:255',
        'milestone_3_month' => 'nullable|integer|min:1|max:60',
        ]);
